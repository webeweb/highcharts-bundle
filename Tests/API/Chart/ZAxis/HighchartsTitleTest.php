...
final class HighchartsTitleTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39];
        ...
        $res5 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with reserve space");

        $obj->setRotation(20);

        $res6 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0, "rotation" => 20];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with rotation");

        $obj->setStyle(["style" => "a1b01e734b573fca08eb1a65e6df9a38"]);

        $res7 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0, "rotation" => 20, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"]];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with style");

        $obj->setText("1cb251ec0d568de6a929b520c4aed8d1");

        $res8 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0, "rotation" => 20, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with text");

        $obj->setX(2);

        $res9 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0, "rotation" => 20, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "x" => 2];
        $this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with x");

        $obj->setY(49);

        $res10 = ["align" => "high", "enabled" => "a10311459433adf322f2590a4987c423", "margin" => 63, "offset" => 39, "reserveSpace" => 0, "rotation" => 20, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "x" => 2, "y" => 49];
