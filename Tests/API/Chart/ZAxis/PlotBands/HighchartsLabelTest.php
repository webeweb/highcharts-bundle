...
final class HighchartsLabelTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res6 = ["align" => "f792d1afb0399dce47533bead9d71a8a", "rotation" => 86, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "textAlign" => "6e1fcbf7c065b2e7fef4cdc9bae3fe53", "useHTML" => 0];
        ...
        $res7 = ["align" => "f792d1afb0399dce47533bead9d71a8a", "rotation" => 86, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "textAlign" => "6e1fcbf7c065b2e7fef4cdc9bae3fe53", "useHTML" => 0, "verticalAlign" => "ca9e085e0fcf449934cc13d9e60dd722"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with vertical align");

        $obj->setX(3);

        $res8 = ["align" => "f792d1afb0399dce47533bead9d71a8a", "rotation" => 86, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "textAlign" => "6e1fcbf7c065b2e7fef4cdc9bae3fe53", "useHTML" => 0, "verticalAlign" => "ca9e085e0fcf449934cc13d9e60dd722", "x" => 3];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with x");

        $obj->setY(36);

        $res9 = ["align" => "f792d1afb0399dce47533bead9d71a8a", "rotation" => 86, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "text" => "1cb251ec0d568de6a929b520c4aed8d1", "textAlign" => "6e1fcbf7c065b2e7fef4cdc9bae3fe53", "useHTML" => 0, "verticalAlign" => "ca9e085e0fcf449934cc13d9e60dd722", "x" => 3, "y" => 36];
