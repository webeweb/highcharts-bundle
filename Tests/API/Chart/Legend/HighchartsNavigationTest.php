...
final class HighchartsNavigationTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\Legend\HighchartsNavigation(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\Legend\HighchartsNavigation(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\Legend\HighchartsNavigation(true);
    ...
    public function testToArray() {
        ...
        $res3 = ["activeColor" => "e696f1ec7e5059eee9c79e452a2547cd", "animation" => 0, "arrowSize" => 78];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with arrow size");

        $obj->setEnabled(1);

        $res4 = ["activeColor" => "e696f1ec7e5059eee9c79e452a2547cd", "animation" => 0, "arrowSize" => 78, "enabled" => 1];
        ...
        $res5 = ["activeColor" => "e696f1ec7e5059eee9c79e452a2547cd", "animation" => 0, "arrowSize" => 78, "enabled" => 1, "inactiveColor" => "b3a75fd77d41e4b05a9ca48090851664"];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with inactive color");

        $obj->setStyle(["style" => "a1b01e734b573fca08eb1a65e6df9a38"]);

        $res6 = ["activeColor" => "e696f1ec7e5059eee9c79e452a2547cd", "animation" => 0, "arrowSize" => 78, "enabled" => 1, "inactiveColor" => "b3a75fd77d41e4b05a9ca48090851664", "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"]];
