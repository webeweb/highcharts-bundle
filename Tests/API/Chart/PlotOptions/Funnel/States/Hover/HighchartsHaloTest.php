...
final class HighchartsHaloTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Funnel\States\Hover\HighchartsHalo(true);

        $this->assertNull($obj1->getAttributes());
        $this->assertNull($obj1->getOpacity());
        $this->assertNull($obj1->getSize());

        $obj0 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Funnel\States\Hover\HighchartsHalo(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Funnel\States\Hover\HighchartsHalo(true);
    ...
    public function testToArray() {
        ...
        $res3 = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 15, "size" => 75];
