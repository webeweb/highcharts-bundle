...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\States\Hover;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 11, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(87);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 11, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88, "radius" => 87];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates("");

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 11, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88, "radius" => 87, "states" => ""];
        ...
        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 11, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88, "radius" => 87, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(49);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 11, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 88, "radius" => 87, "states" => "", "symbol" => "triangle-down", "width" => 49];
