...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\States;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\HighchartsHover(true);
        ...
        $obj0 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\HighchartsHover(false);
    ...
    public function testClear() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\HighchartsHover(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\HighchartsHover(true);
    ...
    public function testNewMarker() {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\Hover\HighchartsMarker::class, $res, "The method newMarker() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res4 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 64];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setLineWidthPlus(67);

        $res5 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 64, "lineWidthPlus" => 67];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width plus");

        $obj->setMarker(new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Bar\States\Hover\HighchartsMarker());

        $res6 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 64, "lineWidthPlus" => 67, "marker" => []];
