...
namespace WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\Point;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Bar\Point
 * @version 5.0.14
 */
final class HighchartsEventsTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Bar\Point\HighchartsEvents(true);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Bar\Point\HighchartsEvents(true);
