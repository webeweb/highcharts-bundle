...
final class HighchartsPieTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        ...
        $res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"]];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with center");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColorIndex(9);

        $res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCursor("crosshair");

        $res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair"];
        ...
        $res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => []];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(10);

        $res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786"];
        ...
        $res14 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with enable mouse tracking");

        $obj->setEndAngle(59);

        $res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59];
        ...
        $res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => []];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(1);

        $res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
        ...
        $res19 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
        ...
        $res20 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1];
        ...
        $res21 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672"];
        $this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with inner size");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res22 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res23 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res23, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMinSize(80);

        $res24 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80];
        ...
        $res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => []];
        $this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0];
        ...
        $res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1];
        ...
        $res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24"];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with size");

        $obj->setSkipKeyboardNavigation(0);

        $res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with skip keyboard navigation");

        $obj->setSlicedOffset(41);

        $res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with sliced offset");

        $obj->setStartAngle(41);

        $res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41, "startAngle" => 41];
        ...
        $res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41, "startAngle" => 41, "states" => []];
        ...
        $res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41, "startAngle" => 41, "states" => [], "stickyTracking" => 0];
        ...
        $res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41, "startAngle" => 41, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        $this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

        $obj->setVisible(1);

        $res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 2, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 77, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 9, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "dataLabels" => [], "depth" => 10, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 59, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "ignoreHiddenPoint" => 1, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 80, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 41, "startAngle" => 41, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "visible" => 1];
