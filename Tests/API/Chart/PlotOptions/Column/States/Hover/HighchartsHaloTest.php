...
final class HighchartsHaloTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Column\States\Hover\HighchartsHalo(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Column\States\Hover\HighchartsHalo(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Column\States\Hover\HighchartsHalo(true);
	...
	public function testToArray() {
		...
		$res3 = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 10, "size" => 86];
