...
final class HighchartsErrorbarTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res10 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
		...
		$res11 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		...
		$res12 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "maxPointWidth" => 80];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

		$obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

		$res13 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "maxPointWidth" => 80, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
		...
		$res18 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "maxPointWidth" => 80, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointRange" => 53];
		$this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with point range");

		$obj->setPointWidth(3);

		$res19 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "maxPointWidth" => 80, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointRange" => 53, "pointWidth" => 3];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with point width");

		$obj->setSkipKeyboardNavigation(0);

		$res20 = ["allowPointSelect" => false, "color" => "#000000", "colorByPoint" => false, "crisp" => true, "depth" => 25, "edgeWidth" => 1, "enableMouseTracking" => true, "getExtremesFromAll" => false, "groupZPadding" => 1, "lineWidth" => 1, "linkedTo" => ":previous", "pointInterval" => 1, "pointPadding" => 0.1, "pointStart" => 0, "selected" => false, "stemDashStyle" => "Solid", "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "whiskerLength" => "50%", "zoneAxis" => "y", "animationLimit" => 54, "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 6, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "maxPointWidth" => 80, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointRange" => 53, "pointWidth" => 3, "skipKeyboardNavigation" => 0];
