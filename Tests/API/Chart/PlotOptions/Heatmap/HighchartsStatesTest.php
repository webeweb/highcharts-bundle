...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
	...
	public function testClear() {
		...
		$obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Heatmap\HighchartsStates(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Heatmap\HighchartsStates(true);
	...
	public function testNewHover() {
		...
		$res = $obj->newHover();
		$this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Heatmap\States\HighchartsHover::class, $res, "The method newHover() does not return the expected object");
	}
	...
	public function testToArray() {
		...
		$obj->setHover(new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Heatmap\States\HighchartsHover());
