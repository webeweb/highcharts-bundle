...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 27, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 97];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(26);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 27, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 97, "radius" => 26];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setStates("");

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 27, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 97, "radius" => 26, "states" => ""];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setSymbol("triangle-down");

        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 27, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 97, "radius" => 26, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray());

        $obj->setWidth(38);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 27, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 97, "radius" => 26, "states" => "", "symbol" => "triangle-down", "width" => 38];
