...
namespace WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Series\Marker\States;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Series\Marker\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Series\Marker\States\HighchartsHover(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Series\Marker\States\HighchartsHover(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Series\Marker\States\HighchartsHover(true);
    ...
    public function testToArray() {
        ...
        $res4 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 62];
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 62, "lineWidthPlus" => 78];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width plus");

        $obj->setRadius(96);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 62, "lineWidthPlus" => 78, "radius" => 96];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setRadiusPlus(49);

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 62, "lineWidthPlus" => 78, "radius" => 96, "radiusPlus" => 49];
