...
use WBW\HighchartsBundle\API\Chart\PlotOptions\Series\HighchartsTooltip;
...
final class HighchartsTooltipTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res4 = ["followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "split" => false, "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "valueDecimals" => 97];
		...
		$res5 = ["followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "split" => false, "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "valueDecimals" => 97, "valuePrefix" => "5fde1c8b25eb2ea19ff8377e62564818"];
		...
		$res6 = ["followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "split" => false, "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "valueDecimals" => 97, "valuePrefix" => "5fde1c8b25eb2ea19ff8377e62564818", "valueSuffix" => "bf995908ddff004471c953d8062bd1db"];
		...
		$res7 = ["followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "split" => false, "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "valueDecimals" => 97, "valuePrefix" => "5fde1c8b25eb2ea19ff8377e62564818", "valueSuffix" => "bf995908ddff004471c953d8062bd1db", "xDateFormat" => "e24debfa0bc8408e1dda05cbd537a072"];
