...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 53];
        ...
        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 53, "states" => []];
        ...
        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 53, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(19);

        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 53, "states" => [], "symbol" => "triangle-down", "width" => 19];
