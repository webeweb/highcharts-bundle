...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewHover() {
		...
		$res = $obj->newHover();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Bubble\Marker\States\HighchartsHover::class, $res, "The method newHover() does not return the expected class");
	}
	...
	public function testNewSelect() {
		...
		$res = $obj->newSelect();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Bubble\Marker\States\HighchartsSelect::class, $res, "The method newSelect() does not return the expected class");
	}
