...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewMarker() {
		...
		$res = $obj->newMarker();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Bubble\States\Hover\HighchartsMarker::class, $res, "The method newMarker() does not return the expected class");
	}
