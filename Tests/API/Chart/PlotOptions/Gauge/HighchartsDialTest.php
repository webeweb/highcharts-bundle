...
final class HighchartsDialTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76];
        $this->assertEquals($res3, $obj->toArray());

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        $this->assertEquals($res4, $obj->toArray());

        $obj->setBorderWidth(63);

        $res5 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 63];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius("fc021d54683383e5078ab9fefc4d53c8");

        $res6 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 63, "radius" => "fc021d54683383e5078ab9fefc4d53c8"];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setRearLength("cfeff8818f149d68732253aca8a5c4bf");

        $res7 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 63, "radius" => "fc021d54683383e5078ab9fefc4d53c8", "rearLength" => "cfeff8818f149d68732253aca8a5c4bf"];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setTopWidth(64);

        $res8 = ["backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "baseLength" => "908389f95bb7d5ec0ee86df707120146", "baseWidth" => 76, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 63, "radius" => "fc021d54683383e5078ab9fefc4d53c8", "rearLength" => "cfeff8818f149d68732253aca8a5c4bf", "topWidth" => 64];
