...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Areaspline\Marker\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 86];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(94);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 86, "radius" => 94];
        ...
        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 86, "radius" => 94, "states" => []];
        ...
        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 86, "radius" => 94, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(63);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 80, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 86, "radius" => 94, "states" => [], "symbol" => "triangle-down", "width" => 63];
