...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 11];
        $this->assertEquals($res4, $obj->toArray());

        $obj->setLineWidthPlus(48);

        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 11, "lineWidthPlus" => 48];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(55);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 11, "lineWidthPlus" => 48, "radius" => 55];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setRadiusPlus(18);

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 11, "lineWidthPlus" => 48, "radius" => 55, "radiusPlus" => 18];
