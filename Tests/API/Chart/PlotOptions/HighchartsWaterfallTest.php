...
final class HighchartsWaterfallTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewDataLabels() {
        ...
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Waterfall\HighchartsDataLabels::class, $res, "The method newDataLabels() does not return the expected object");
    }
    ...
    public function testNewEvents() {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Waterfall\HighchartsEvents::class, $res, "The method newEvents() does not return the expected object");
    }
    ...
    public function testNewPoint() {
        ...
        $res = $obj->newPoint();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Waterfall\HighchartsPoint::class, $res, "The method newPoint() does not return the expected object");
    }
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Waterfall\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res3 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with border color");

        $obj->setBorderRadius(73);

        $res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(1);

        $res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCursor("crosshair");

        $res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair"];
        ...
        $res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => []];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(53);

        $res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(5);

        $res19 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5];
        ...
        $res20 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0];
        ...
        $res21 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => []];
        $this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(1);

        $res22 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res23 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
        ...
        $res24 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
        $this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with get extremes from all");

        $obj->setGroupPadding(69);

        $res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69];
        ...
        $res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(0);

        $res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");

        $res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with line color");

        $obj->setLineWidth(98);

        $res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMaxPointWidth(76);

        $res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76];
        ...
        $res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72];
        ...
        $res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => []];
        $this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(9);

        $res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9];
        $this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year"];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point interval unit");

        $obj->setPointPadding(75);

        $res38 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75];
        $this->assertEquals($res38, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res39 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between"];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

        $obj->setPointRange(85);

        $res40 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85];
        $this->assertEquals($res40, $obj->toArray(), "The method toArray() does not return the expected array with point range");

        $obj->setPointStart(0);

        $res41 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point start");

        $obj->setPointWidth(79);

        $res42 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(1);

        $res43 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1];
        $this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res44 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0];
        ...
        $res45 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1];
        ...
        $res46 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res47 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
        ...
        $res50 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0];
        ...
        $res52 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0, "threshold" => 85, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res53 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0, "threshold" => 85, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "upColor" => "a0ad37cccbf214955f19b240232be957"];
        $this->assertEquals($res53, $obj->toArray(), "The method toArray() does not return the expected array with up color");

        $obj->setVisible(0);

        $res54 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0, "threshold" => 85, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res55 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0, "threshold" => 85, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res56 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 91, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 73, "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 43, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "dataLabels" => [], "depth" => 53, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 5, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 69, "groupZPadding" => 58, "grouping" => 0, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 98, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "minPointLength" => 72, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 9, "pointIntervalUnit" => "year", "pointPadding" => 75, "pointPlacement" => "between", "pointRange" => 85, "pointStart" => 0, "pointWidth" => 79, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 0, "states" => [], "stickyTracking" => 0, "threshold" => 85, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
