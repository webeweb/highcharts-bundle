...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["animation" => 1, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 0];
        ...
        $res5 = ["animation" => 1, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 0, "lineWidthPlus" => 68];
        ...
        $res6 = ["animation" => 1, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 0, "lineWidthPlus" => 68, "marker" => []];
