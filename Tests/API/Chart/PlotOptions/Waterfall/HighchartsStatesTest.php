...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewHover() {
		...
		$res = $obj->newHover();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Waterfall\States\HighchartsHover::class, $res, "The method newHover() does not return the expected class");
	}
