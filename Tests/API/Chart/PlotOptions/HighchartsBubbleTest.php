...
final class HighchartsBubbleTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res1 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 83];
		$this->assertEquals($res1, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res2 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 83, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res2, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

		$res3 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 83, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
		...
		$res13 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 83, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 8, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "marker" => ["marker" => "b272bda9bf0c1cdcba614b5ed99c4d62"]];
