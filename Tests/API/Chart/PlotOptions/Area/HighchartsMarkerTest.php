...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\HighchartsMarker(false);
    ...
    public function testClear() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\HighchartsMarker(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\HighchartsMarker(true);
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Area\Marker\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 60, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 99];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(80);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 60, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 99, "radius" => 80];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates(new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\Marker\HighchartsStates());

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 60, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 99, "radius" => 80, "states" => []];
        ...
        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 60, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 99, "radius" => 80, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(22);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 60, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 99, "radius" => 80, "states" => [], "symbol" => "triangle-down", "width" => 22];
