...
use WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\Hover\HighchartsMarker;
 ...
 * @package HighchartsBundle\Tests\API\Chart\PlotOptions\Area\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res6 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 89, "states" => "", "symbol" => "97bff26855a8bfa63e05d5477e794b24", "width" => 77];
