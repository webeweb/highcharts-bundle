...
namespace WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Area\States;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Area\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\HighchartsHover(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\HighchartsHover(false);
    ...
    public function testClear() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\HighchartsHover(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\HighchartsHover(true);
    ...
    public function testNewMarker() {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\Hover\HighchartsMarker::class, $res, "The method newMarker() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res4 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 86];
        ...
        $res5 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 86, "lineWidthPlus" => 33];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width plus");

        $obj->setMarker(new \WBW\HighchartsBundle\API\Chart\PlotOptions\Area\States\Hover\HighchartsMarker());

        $res6 = ["animation" => 1, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 86, "lineWidthPlus" => 33, "marker" => []];
