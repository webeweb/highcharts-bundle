...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $obj->setBrightness(37);

        $res3 = ["animation" => 0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 37];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with brightness");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res4 = ["animation" => 0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 37, "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setEnabled(1);

        $res5 = ["animation" => 0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 37, "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "enabled" => 1];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with enabled");

        $obj->setOpacity(19);

        $res6 = ["animation" => 0, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 37, "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "enabled" => 1, "opacity" => 19];
