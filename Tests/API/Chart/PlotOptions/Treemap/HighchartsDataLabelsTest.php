...
final class HighchartsDataLabelsTest extends PHPUnit_Framework_TestCase {
	...
	public function testClear() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Treemap\HighchartsDataLabels(false);
	...
	public function testToArray() {
		...
		$res = ["align" => "center", "allowOverlap" => false, "borderRadius" => 0, "borderWidth" => 0, "crop" => true, "defer" => false, "enabled" => true, "format" => "{y}", "inside" => true, "overflow" => "justify", "padding" => 5, "rotation" => 0, "shadow" => false, "shape" => "square", "style" => ["color" => "contrast", "fontSize" => "11px", "fontWeight" => "bold", "textOutline" => "1px contrast"], "useHTML" => false, "verticalAlign" => "middle", "x" => 0, "y" => -6, "zIndex" => 6];
