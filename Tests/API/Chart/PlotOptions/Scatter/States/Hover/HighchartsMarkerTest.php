...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 10, "states" => "", "symbol" => "triangle-down"];
		$this->assertEquals($res5, $obj->toArray(), 'The method toArray() does not return the expected array with symbol');

		$obj->setWidth(84);

		$res6 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 10, "states" => "", "symbol" => "triangle-down", "width" => 84];
