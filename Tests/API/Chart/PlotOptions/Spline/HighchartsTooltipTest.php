...
final class HighchartsTooltipTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res7 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 1, "followTouchMove" => 0, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 28, "padding" => 8];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setPointFormat("332dd3de68dc71de0745837cbc13e217");

        $res8 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 1, "followTouchMove" => 0, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 28, "padding" => 8, "pointFormat" => "332dd3de68dc71de0745837cbc13e217"];
        $this->assertEquals($res8, $obj->toArray());

        $obj->setPointFormatter("d0b51d7b9a5189f718d161b366d33044");

        $res9 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 1, "followTouchMove" => 0, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 28, "padding" => 8, "pointFormat" => "332dd3de68dc71de0745837cbc13e217", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044"];
