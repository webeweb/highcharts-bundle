...
final class HighchartsTooltipTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Spline\HighchartsTooltip(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Spline\HighchartsTooltip(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Spline\HighchartsTooltip(true);
    ...
    public function testToArray() {
        ...
        $res6 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 0, "followTouchMove" => 1, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 77];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with hide delay");

        $obj->setPadding(12);

        $res7 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 0, "followTouchMove" => 1, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 77, "padding" => 12];
        ...
        $res8 = ["dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "followPointer" => 0, "followTouchMove" => 1, "footerFormat" => "1ac32e030fc5ef01e703d5419170690e", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "hideDelay" => 77, "padding" => 12, "pointFormat" => "332dd3de68dc71de0745837cbc13e217"];
