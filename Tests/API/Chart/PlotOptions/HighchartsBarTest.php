...
final class HighchartsBarTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with border color");

        $obj->setBorderRadius(87);

        $res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(0);

        $res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(1);

        $res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(75);

        $res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair"];
        ...
        $res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => []];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(84);

        $res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(21);

        $res19 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

        $obj->setEnableMouseTracking(1);

        $res20 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1];
        ...
        $res21 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(0);

        $res22 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0];
        ...
        $res23 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
        ...
        $res24 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        $this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with get extremes from all");

        $obj->setGroupPadding(0);

        $res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0];
        ...
        $res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(1);

        $res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMaxPointWidth(83);

        $res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

        $obj->setMinPointLength(63);

        $res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63];
        ...
        $res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
        ...
        $res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => []];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year"];
        ...
        $res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res38 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between"];
        $this->assertEquals($res38, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

        $obj->setPointRange(30);

        $res39 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point range");

        $obj->setPointStart(34);

        $res40 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34];
        ...
        $res41 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(0);

        $res42 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res43 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0];
        ...
        $res44 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0];
        ...
        $res45 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0];
        $this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(0);

        $res46 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0];
        ...
        $res47 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0];
        ...
        $res50 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1];
        ...
        $res52 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 17, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        $this->assertEquals($res52, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

        $obj->setTurboThreshold(5);

        $res53 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 17, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 5];
        $this->assertEquals($res53, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setVisible(1);

        $res54 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 17, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 5, "visible" => 1];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res55 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 17, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 5, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res56 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 19, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 87, "borderWidth" => 10, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 75, "cursor" => "crosshair", "dataLabels" => [], "depth" => 84, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 21, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 41, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 83, "minPointLength" => 63, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 40, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 30, "pointStart" => 34, "pointWidth" => 74, "selected" => 0, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 17, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 5, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
