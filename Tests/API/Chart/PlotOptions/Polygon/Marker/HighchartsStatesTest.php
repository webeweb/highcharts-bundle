...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\HighchartsStates(true);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\HighchartsStates(true);
    ...
    public function testNewHover() {
        ...
        $res = $obj->newHover();
        $this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\States\HighchartsHover::class, $res, "The method newHover() does not return the expected object");
    }
    ...
    public function testNewSelect() {
        ...
        $res = $obj->newSelect();
        $this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\States\HighchartsSelect::class, $res, "The method newSelect() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $obj->setHover(new \WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\States\HighchartsHover());

        $res1 = ["hover" => []];
        $this->assertEquals($res1, $obj->toArray(), "The method toArray() does not return the expected array with hover");

        $obj->setSelect(new \WBW\HighchartsBundle\API\Chart\PlotOptions\Polygon\Marker\States\HighchartsSelect());
