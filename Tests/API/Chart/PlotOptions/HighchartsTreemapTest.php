...
final class HighchartsTreemapTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

		$res6 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
		...
		$res7 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res8 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

		$res9 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with color");

		$obj->setColorByPoint(1);

		$res10 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
		...
		$res11 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res12 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setCrisp(0);

		$res13 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0];
		...
		$res14 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78];
		$this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

		$obj->setCursor("crosshair");

		$res15 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair"];
		...
		$res16 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => []];
		$this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res17 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786"];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with description");

		$obj->setEnableMouseTracking(1);

		$res18 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1];
		...
		$res19 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => []];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(1);

		$res20 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1];
		...
		$res21 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
		...
		$res23 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1];
		...
		$res24 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with interact by leaf");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res25 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		...
		$res26 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip"];
		...
		$res27 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal"];
		...
		$res28 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false"];
		...
		$res31 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76];
		$this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

		$obj->setOpacity(1);

		$res32 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1];
		...
		$res33 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => []];
		$this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res34 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res35 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0];
		$this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setShadow(1);

		$res36 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1];
		...
		$res37 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1];
		...
		$res38 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1];
		...
		$res40 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82];
		...
		$res41 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => []];
		...
		$res42 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1];
		...
		$res43 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1, "tooltip" => []];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setTurboThreshold(90);

		$res44 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1, "tooltip" => [], "turboThreshold" => 90];
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

		$obj->setVisible(0);

		$res45 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1, "tooltip" => [], "turboThreshold" => 90, "visible" => 0];
		$this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with visible");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res46 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1, "tooltip" => [], "turboThreshold" => 90, "visible" => 0, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res47 = ["allowDrillToNode" => "true", "allowPointSelect" => 0, "alternateStartingDirection" => 1, "animation" => 1, "animationLimit" => 17, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 22, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 12, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 78, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "ignoreHiddenPoint" => 1, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "layoutAlgorithm" => "strip", "layoutStartingDirection" => "horizontal", "levelIsConstant" => "false", "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 76, "opacity" => 1, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 1, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "sortIndex" => 82, "states" => [], "stickyTracking" => 1, "tooltip" => [], "turboThreshold" => 90, "visible" => 0, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
