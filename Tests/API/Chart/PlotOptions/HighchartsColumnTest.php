...
final class HighchartsColumnTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with border color");

        $obj->setBorderRadius(18);

        $res5 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with border radius");

        $obj->setBorderWidth(73);

        $res6 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res9 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        ...
        $res10 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(1);

        $res12 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
        ...
        $res13 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair"];
        ...
        $res15 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => []];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(50);

        $res16 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res17 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res18 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(48);

        $res19 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

        $obj->setEnableMouseTracking(1);

        $res20 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1];
        ...
        $res21 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(1);

        $res22 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res23 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
        ...
        $res24 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
        ...
        $res25 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90];
        $this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with group padding");

        $obj->setGroupZPadding(47);

        $res26 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(1);

        $res27 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res28 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res29 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419"];
        ...
        $res30 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

        $obj->setMinPointLength(75);

        $res31 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75];
        ...
        $res32 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
        ...
        $res33 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => []];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res34 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(45);

        $res35 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res36 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year"];
        ...
        $res37 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res38 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between"];
        ...
        $res39 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14];
        ...
        $res40 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10];
        ...
        $res41 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(0);

        $res42 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(1);

        $res43 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1];
        ...
        $res44 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0];
        ...
        $res45 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0];
        $this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(0);

        $res46 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0];
        ...
        $res47 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1];
        ...
        $res50 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0];
        ...
        $res52 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 12, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res53 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 12, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 33];
        $this->assertEquals($res53, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setVisible(1);

        $res54 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 12, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 33, "visible" => 1];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res55 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 12, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 33, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res56 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 18, "borderWidth" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 44, "cursor" => "crosshair", "dataLabels" => [], "depth" => 50, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 48, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 90, "groupZPadding" => 47, "grouping" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "minPointLength" => 75, "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 45, "pointIntervalUnit" => "year", "pointPadding" => 79, "pointPlacement" => "between", "pointRange" => 14, "pointStart" => 10, "pointWidth" => 33, "selected" => 0, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "softThreshold" => 1, "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 12, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 33, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
