...
final class HighchartsEventsTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Line\HighchartsEvents(true);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Line\HighchartsEvents(true);
