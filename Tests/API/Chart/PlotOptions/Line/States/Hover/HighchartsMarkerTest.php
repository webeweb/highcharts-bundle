...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Line\States\Hover;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\PlotOptions\Line\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Line\States\Hover\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Line\States\Hover\HighchartsMarker(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Line\States\Hover\HighchartsMarker(true);
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 25, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 82];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(92);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 25, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 82, "radius" => 92];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates("");

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 25, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 82, "radius" => 92, "states" => ""];
        ...
        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 25, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 82, "radius" => 92, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(38);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 25, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 82, "radius" => 92, "states" => "", "symbol" => "triangle-down", "width" => 38];
