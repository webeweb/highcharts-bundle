...
namespace WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Boxplot\States;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\PlotOptions\Boxplot\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 81, "lineWidthPlus" => 53];
        ...
        $res6 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 81, "lineWidthPlus" => 53, "marker" => []];
