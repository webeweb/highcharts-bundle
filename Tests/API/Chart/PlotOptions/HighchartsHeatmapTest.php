...
final class HighchartsHeatmapTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        ...
        $res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setColsize(75);

        $res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with colsize");

        $obj->setCrisp(1);

        $res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1];
        ...
        $res14 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair"];
        ...
        $res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => []];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEnableMouseTracking(1);

        $res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1];
        ...
        $res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69];
        ...
        $res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => []];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with rowsize");

        $obj->setSelected(1);

        $res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(1);

        $res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1];
        ...
        $res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0];
        ...
        $res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1];
        ...
        $res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => []];
        ...
        $res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1];
        ...
        $res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 62];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setVisible(1);

        $res38 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 62, "visible" => 1];
        $this->assertEquals($res38, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res39 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 62, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res40 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 26, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 52, "borderWidth" => 20, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 97, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 75, "crisp" => 1, "cropThreshold" => 82, "cursor" => "crosshair", "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 69, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 73, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 62, "visible" => 1, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
