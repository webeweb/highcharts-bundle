...
final class HighchartsChartTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with border radius");

		$obj->setBorderWidth(87);

		$res6 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res7 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColorCount(85);

		$res8 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85];
		...
		$res9 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie"];
		...
		$res10 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786"];
		...
		$res11 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => []];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setHeight(95);

		$res12 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95];
		...
		$res13 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with ignore hidden series");

		$obj->setInverted(1);

		$res14 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1];
		...
		$res15 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"]];
		$this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with margin");

		$obj->setMarginBottom(94);

		$res16 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94];
		$this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with margin bottom");

		$obj->setMarginLeft(94);

		$res17 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with margin left");

		$obj->setMarginRight(4);
		...
		$res24 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5"];
		...
		$obj->setPlotBorderWidth(76);

		$res27 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with plot border width");

		$obj->setPlotShadow(1);

		$res28 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1];
		...
		$res32 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1, "polar" => 0, "reflow" => 1, "renderTo" => "6cdf914b87eb7733ae56819ec32f386e", "resetZoomButton" => []];
		...
		$res33 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1, "polar" => 0, "reflow" => 1, "renderTo" => "6cdf914b87eb7733ae56819ec32f386e", "resetZoomButton" => [], "selectionMarkerFill" => "b837c10405112fa4a26778688bd27245"];
		...
		$res43 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1, "polar" => 0, "reflow" => 1, "renderTo" => "6cdf914b87eb7733ae56819ec32f386e", "resetZoomButton" => [], "selectionMarkerFill" => "b837c10405112fa4a26778688bd27245", "shadow" => 0, "showAxes" => 1, "spacing" => ["spacing" => "348b374e34b64661f5976e46c7a5c08a"], "spacingBottom" => 67, "spacingLeft" => 3, "spacingRight" => 7, "spacingTop" => 54, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "type" => "waterfall", "typeDescription" => "03c3ff624590aba1e18136e967cc7455"];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with type description");

		$obj->setWidth(77);

		$res44 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1, "polar" => 0, "reflow" => 1, "renderTo" => "6cdf914b87eb7733ae56819ec32f386e", "resetZoomButton" => [], "selectionMarkerFill" => "b837c10405112fa4a26778688bd27245", "shadow" => 0, "showAxes" => 1, "spacing" => ["spacing" => "348b374e34b64661f5976e46c7a5c08a"], "spacingBottom" => 67, "spacingLeft" => 3, "spacingRight" => 7, "spacingTop" => 54, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "type" => "waterfall", "typeDescription" => "03c3ff624590aba1e18136e967cc7455", "width" => 77];
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with width");

		$obj->setZoomType("xy");

		$res45 = ["alignTicks" => 1, "animation" => 0, "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 22, "borderWidth" => 87, "className" => "6f66e878c62db60568a3487869695820", "colorCount" => 85, "defaultSeriesType" => "pie", "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "height" => 95, "ignoreHiddenSeries" => 0, "inverted" => 1, "margin" => ["margin" => "d42f4851e770aa0f758b01388874f67b"], "marginBottom" => 94, "marginLeft" => 94, "marginRight" => 4, "marginTop" => 30, "options3d" => [], "panKey" => "shift", "panning" => 0, "pinchType" => "xy", "plotBackgroundColor" => "c2f8b5b51823d8d11973591af04340d5", "plotBackgroundImage" => "dace675e2a249a414ee3940daf49807f", "plotBorderColor" => "76ac5d1e39e38330d708ac4e5f27162d", "plotBorderWidth" => 76, "plotShadow" => 1, "polar" => 0, "reflow" => 1, "renderTo" => "6cdf914b87eb7733ae56819ec32f386e", "resetZoomButton" => [], "selectionMarkerFill" => "b837c10405112fa4a26778688bd27245", "shadow" => 0, "showAxes" => 1, "spacing" => ["spacing" => "348b374e34b64661f5976e46c7a5c08a"], "spacingBottom" => 67, "spacingLeft" => 3, "spacingRight" => 7, "spacingTop" => 54, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "type" => "waterfall", "typeDescription" => "03c3ff624590aba1e18136e967cc7455", "width" => 77, "zoomType" => "xy"];
