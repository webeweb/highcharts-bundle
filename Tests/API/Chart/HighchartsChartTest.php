...
final class HighchartsChartTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewEvents() {
		...
		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Chart\HighchartsEvents::class, $res, "The method newEvents() does not return the expected class");
	}
	...
	public function testNewOptions3d() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Chart\HighchartsOptions3d::class, $res, "The method newOptions3d() does not return the expected class");
	}
	...
	public function testNewResetZoomButton() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Chart\HighchartsResetZoomButton::class, $res, "The method newResetZoomButton() does not return the expected class");
	}
