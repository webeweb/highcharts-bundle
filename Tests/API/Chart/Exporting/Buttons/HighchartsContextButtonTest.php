...
final class HighchartsContextButtonTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["align" => "right", "enabled" => 1, "height" => 93];
        ...
        $res4 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"]];
        ...
        $res5 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e"];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with onclick");

        $obj->setSymbol("menu");

        $res6 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu"];
        ...
        $res7 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with symbol fill");

        $obj->setSymbolSize(5);

        $res8 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5];
        ...
        $res9 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a"];
        $this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with symbol stroke");

        $obj->setSymbolStrokeWidth(43);

        $res10 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with symbol stroke width");

        $obj->setSymbolX(9);

        $res11 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with symbol x");

        $obj->setSymbolY(71);

        $res12 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with symbol y");

        $obj->setText("1cb251ec0d568de6a929b520c4aed8d1");

        $res13 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1"];
        ...
        $res14 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1", "theme" => ["theme" => "f484570d7cf557020e11ace406901b10"]];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with theme");

        $obj->setVerticalAlign("bottom");

        $res15 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1", "theme" => ["theme" => "f484570d7cf557020e11ace406901b10"], "verticalAlign" => "bottom"];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with vertical align");

        $obj->setWidth(75);

        $res16 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1", "theme" => ["theme" => "f484570d7cf557020e11ace406901b10"], "verticalAlign" => "bottom", "width" => 75];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with width");

        $obj->setX(85);

        $res17 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1", "theme" => ["theme" => "f484570d7cf557020e11ace406901b10"], "verticalAlign" => "bottom", "width" => 75, "x" => 85];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with x");

        $obj->setY(26);

        $res18 = ["align" => "right", "enabled" => 1, "height" => 93, "menuItems" => ["menuItems" => "3081c7ff634acf2d84cebc0fe12eef3f"], "onclick" => "c0bb2196426022e8adf9a5b6d34fd45e", "symbol" => "menu", "symbolFill" => "91c9eea38e42d2f606dbfea1e027bfbf", "symbolSize" => 5, "symbolStroke" => "07f92b4194c5eb604aeb59004eeaab2a", "symbolStrokeWidth" => 43, "symbolX" => 9, "symbolY" => 71, "text" => "1cb251ec0d568de6a929b520c4aed8d1", "theme" => ["theme" => "f484570d7cf557020e11ace406901b10"], "verticalAlign" => "bottom", "width" => 75, "x" => 85, "y" => 26];
