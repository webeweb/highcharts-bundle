...
final class HighchartsLegendTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$obj->setBorderRadius(91);

		$res4 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91];
		...
		$res5 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setEnabled(1);

		$res6 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with enabled");

		$obj->setFloating(1);

		$res7 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with floating");

		$obj->setItemDistance(22);

		$res8 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22];
		...
		$res9 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"]];
		...
		$res13 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"]];
		...
		$res16 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 89, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692"];
		...
		$res29 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 89, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692", "layout" => "vertical", "lineHeight" => 96, "margin" => 21, "maxHeight" => 51, "navigation" => [], "padding" => 0, "reversed" => 0, "rtl" => 1, "shadow" => 1, "squareSymbol" => 0, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "symbolHeight" => 23, "symbolPadding" => 76];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with symbol padding");

		$obj->setSymbolRadius(30);

		$res30 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 89, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692", "layout" => "vertical", "lineHeight" => 96, "margin" => 21, "maxHeight" => 51, "navigation" => [], "padding" => 0, "reversed" => 0, "rtl" => 1, "shadow" => 1, "squareSymbol" => 0, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "symbolHeight" => 23, "symbolPadding" => 76, "symbolRadius" => 30];
		$this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with symbol radius");

		$obj->setSymbolWidth(64);

		$res31 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 89, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692", "layout" => "vertical", "lineHeight" => 96, "margin" => 21, "maxHeight" => 51, "navigation" => [], "padding" => 0, "reversed" => 0, "rtl" => 1, "shadow" => 1, "squareSymbol" => 0, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "symbolHeight" => 23, "symbolPadding" => 76, "symbolRadius" => 30, "symbolWidth" => 64];
		...
		$res32 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 91, "borderWidth" => 53, "enabled" => 1, "floating" => 1, "itemDistance" => 22, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 47, "itemMarginTop" => 14, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 89, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692", "layout" => "vertical", "lineHeight" => 96, "margin" => 21, "maxHeight" => 51, "navigation" => [], "padding" => 0, "reversed" => 0, "rtl" => 1, "shadow" => 1, "squareSymbol" => 0, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"], "symbolHeight" => 23, "symbolPadding" => 76, "symbolRadius" => 30, "symbolWidth" => 64, "title" => []];
