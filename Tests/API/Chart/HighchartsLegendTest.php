...
final class HighchartsLegendTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res4 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55];
		...
		$res5 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setEnabled(0);

		$res6 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with enabled");

		$obj->setFloating(0);

		$res7 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0, "floating" => 0];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with floating");

		$obj->setItemDistance(1);

		$res8 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0, "floating" => 0, "itemDistance" => 1];
		...
		$res9 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0, "floating" => 0, "itemDistance" => 1, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"]];
		...
		$res13 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0, "floating" => 0, "itemDistance" => 1, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 67, "itemMarginTop" => 20, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"]];
		...
		$res16 = ["align" => "right", "backgroundColor" => "930f2a43179a7ae5fc25ed873223e99f", "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 55, "borderWidth" => 41, "enabled" => 0, "floating" => 0, "itemDistance" => 1, "itemHiddenStyle" => ["itemHiddenStyle" => "85396c3e708111e2ae389e4a131b1ff8"], "itemHoverStyle" => ["itemHoverStyle" => "91e12ccdec8780b32ab867d3568c2b0c"], "itemMarginBottom" => 67, "itemMarginTop" => 20, "itemStyle" => ["itemStyle" => "5428035d6f7481541cf715e0f3e29604"], "itemWidth" => 23, "labelFormat" => "201bbcba25ee83a321df388c0f4a889d", "labelFormatter" => "9078f7787367cf94543b3bc9e92d9692"];
