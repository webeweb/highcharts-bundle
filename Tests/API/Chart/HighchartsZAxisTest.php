...
final class HighchartsZAxisTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewCrosshair() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsCrosshair::class, $res, "The method newCrosshair() does not return the expected class");
	}
	...
	public function testNewEvents() {
		...
		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsEvents::class, $res, "The method newEvents() does not return the expected class");
	}
	...
	public function testNewLabels() {
		...
		$res = $obj->newLabels();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsLabels::class, $res, "The method newLabels() does not return the expected class");
	}
	...
	public function testNewTitle() {
		...
		$res = $obj->newTitle();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsTitle::class, $res, "The method newTitle() does not return the expected class");
	}
	...
	public function testToArray() {
		...
		$res18 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"]];
		...
		$res19 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"]];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with plot lines");

		$obj->setSoftMax(51);

		$res20 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51];
		$this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with soft max");

		$obj->setSoftMin(68);

		$res21 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68];
		$this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with soft min");

		$obj->setTickAmount(55);

		$res22 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68, "tickAmount" => 55];
		...
		$res23 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68, "tickAmount" => 55, "tickInterval" => 2];
		$this->assertEquals($res23, $obj->toArray(), "The method toArray() does not return the expected array with tick interval");

		$obj->setTickPixelInterval(78);

		$res24 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68, "tickAmount" => 55, "tickInterval" => 2, "tickPixelInterval" => 78];
		...
		$res25 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68, "tickAmount" => 55, "tickInterval" => 2, "tickPixelInterval" => 78, "tickPositioner" => "c6a22a267ac93652e3443f821bb369bd"];
		...
		$res26 = ["allowDecimals" => true, "endOnTick" => false, "gridLineColor" => "#e6e6e6", "gridLineDashStyle" => "Solid", "gridLineWidth" => 0, "gridZIndex" => 1, "lineColor" => "#ccd6eb", "lineWidth" => 1, "maxPadding" => 0.01, "minPadding" => 0.01, "minorGridLineColor" => "#f2f2f2", "minorGridLineDashStyle" => "Solid", "minorGridLineWidth" => 1, "minorTickColor" => "#999999", "minorTickLength" => 2, "minorTickPosition" => "outside", "minorTickWidth" => 0, "offset" => 0, "opposite" => false, "reversed" => false, "showEmpty" => true, "showFirstLabel" => true, "showLastLabel" => true, "startOfWeek" => 1, "startOnTick" => false, "tickColor" => "#ccd6eb", "tickLength" => 10, "tickPosition" => "outside", "tickWidth" => 1, "type" => "linear", "uniqueNames" => true, "visible" => true, "alternateGridColor" => "e4c3a98e933a4f898d10c74d6b0cc3e9", "categories" => ["categories" => "b0b5ccb4a195a07fd3eed14affb8695f"], "ceiling" => 76, "className" => "6f66e878c62db60568a3487869695820", "crosshair" => [], "dateTimeLabelFormats" => ["dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "floor" => 63, "id" => "b80bb7740288fda1f201890375a60c8f", "labels" => [], "linkedTo" => 63, "max" => 11, "min" => 30, "minRange" => 1, "minTickInterval" => 61, "minorTickInterval" => "bec8a7be3cd5e2a8eff4a3ee2f5c7e2d", "plotBands" => ["plotBands" => "a6eb9963a4bde85c1ff1d28632fe012d"], "plotLines" => ["plotLines" => "ca27823684c96816234d7d97344db89c"], "softMax" => 51, "softMin" => 68, "tickAmount" => 55, "tickInterval" => 2, "tickPixelInterval" => 78, "tickPositioner" => "c6a22a267ac93652e3443f821bb369bd", "tickPositions" => ["tickPositions" => "8c5d1b19e77eea01652836867fe6d741"]];
