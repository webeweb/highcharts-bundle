...
final class HighchartsDataTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["decimalPoint" => ".", "firstRowAsNames" => true, "lineDelimiter" => "\\n", "startColumn" => 0, "startRow" => 0, "switchRowsAndColumns" => false, "columns" => ["columns" => "54ca84a794888fe8d92834787dfa935a"], "complete" => "d9a22d7a8178d5b42a8750123cbfe5b1", "csv" => "628cb5675ff524f3e719b7aa2e88fe3f", "dateFormat" => "mm/dd/YY", "endColumn" => 78];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with end column");

		$obj->setEndRow(34);

		$res6 = ["decimalPoint" => ".", "firstRowAsNames" => true, "lineDelimiter" => "\\n", "startColumn" => 0, "startRow" => 0, "switchRowsAndColumns" => false, "columns" => ["columns" => "54ca84a794888fe8d92834787dfa935a"], "complete" => "d9a22d7a8178d5b42a8750123cbfe5b1", "csv" => "628cb5675ff524f3e719b7aa2e88fe3f", "dateFormat" => "mm/dd/YY", "endColumn" => 78, "endRow" => 34];
		...
		$res7 = ["decimalPoint" => ".", "firstRowAsNames" => true, "lineDelimiter" => "\\n", "startColumn" => 0, "startRow" => 0, "switchRowsAndColumns" => false, "columns" => ["columns" => "54ca84a794888fe8d92834787dfa935a"], "complete" => "d9a22d7a8178d5b42a8750123cbfe5b1", "csv" => "628cb5675ff524f3e719b7aa2e88fe3f", "dateFormat" => "mm/dd/YY", "endColumn" => 78, "endRow" => 34, "googleSpreadsheetKey" => "4c42edbd1e3a85f2857f1e3a5cf3fb59"];
		...
		$res8 = ["decimalPoint" => ".", "firstRowAsNames" => true, "lineDelimiter" => "\\n", "startColumn" => 0, "startRow" => 0, "switchRowsAndColumns" => false, "columns" => ["columns" => "54ca84a794888fe8d92834787dfa935a"], "complete" => "d9a22d7a8178d5b42a8750123cbfe5b1", "csv" => "628cb5675ff524f3e719b7aa2e88fe3f", "dateFormat" => "mm/dd/YY", "endColumn" => 78, "endRow" => 34, "googleSpreadsheetKey" => "4c42edbd1e3a85f2857f1e3a5cf3fb59", "googleSpreadsheetWorksheet" => "b1444e571854190993273e8b1f53b89c"];
		...
		$res9 = ["decimalPoint" => ".", "firstRowAsNames" => true, "lineDelimiter" => "\\n", "startColumn" => 0, "startRow" => 0, "switchRowsAndColumns" => false, "columns" => ["columns" => "54ca84a794888fe8d92834787dfa935a"], "complete" => "d9a22d7a8178d5b42a8750123cbfe5b1", "csv" => "628cb5675ff524f3e719b7aa2e88fe3f", "dateFormat" => "mm/dd/YY", "endColumn" => 78, "endRow" => 34, "googleSpreadsheetKey" => "4c42edbd1e3a85f2857f1e3a5cf3fb59", "googleSpreadsheetWorksheet" => "b1444e571854190993273e8b1f53b89c", "itemDelimiter" => "2b9ff3bde6b855958954383dc46b1d4f"];
