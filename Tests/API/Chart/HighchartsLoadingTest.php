...
final class HighchartsLoadingTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $obj->setHideDuration(96);

        $res1 = ["hideDuration" => 96];
        ...
        $res2 = ["hideDuration" => 96, "labelStyle" => ["labelStyle" => "00faa433bf869443728e502b4f7c6850"]];
        $this->assertEquals($res2, $obj->toArray(), "The method toArray() does not return the expected array with label style");

        $obj->setShowDuration(36);

        $res3 = ["hideDuration" => 96, "labelStyle" => ["labelStyle" => "00faa433bf869443728e502b4f7c6850"], "showDuration" => 36];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with show duration");

        $obj->setStyle(["style" => "a1b01e734b573fca08eb1a65e6df9a38"]);

        $res4 = ["hideDuration" => 96, "labelStyle" => ["labelStyle" => "00faa433bf869443728e502b4f7c6850"], "showDuration" => 36, "style" => ["style" => "a1b01e734b573fca08eb1a65e6df9a38"]];
