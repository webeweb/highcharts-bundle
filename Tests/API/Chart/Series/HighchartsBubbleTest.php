...
final class HighchartsBubbleTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewDataLabels() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsDataLabels::class, $res, "The method newDataLabels() does not return the expected class");
	}
	...
	public function testNewEvents() {
		...
		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsEvents::class, $res, "The method newEvents() does not return the expected class");
	}
	...
	public function testNewPoint() {
		...
		$res = $obj->newPoint();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsPoint::class, $res, "The method newPoint() does not return the expected class");
	}
	...
	public function testNewStates() {
		...
		$res = $obj->newStates();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsStates::class, $res, "The method newStates() does not return the expected class");
	}
	...
	public function testToArray() {
		...
		$res13 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 12, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 47, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 22];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with index");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res14 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 12, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 47, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 22, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(37);

		$res15 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 12, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 47, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 22, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 37];
		$this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res16 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 12, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 47, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 22, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 37, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		...
		$res17 = ["allowPointSelect" => false, "animation" => true, "cropThreshold" => 300, "dashStyle" => "Solid", "displayNegative" => true, "enableMouseTracking" => true, "getExtremesFromAll" => false, "lineWidth" => 0, "maxSize" => "20%", "minSize" => "8", "pointInterval" => 1, "pointStart" => 0, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => true, "sizeBy" => "area", "sizeByAbsoluteValue" => false, "softThreshold" => false, "stickyTracking" => false, "threshold" => 0, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zThreshold" => 0, "zoneAxis" => "y", "animationLimit" => 12, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 47, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 22, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 37, "linkedTo" => "914fab47afc86331ec62837807a29419", "marker" => ["marker" => "b272bda9bf0c1cdcba614b5ed99c4d62"]];
