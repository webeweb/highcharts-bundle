...
final class HighchartsHeatmapTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setColsize(90);

        $res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with colsize");

        $obj->setCrisp(0);

        $res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(56);

        $res14 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair"];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        ...
        $res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEnableMouseTracking(1);

        $res19 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1];
        ...
        $res20 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(1);

        $res21 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res23 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        ...
        $res24 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(18);

        $res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18];
        $this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(34);

        $res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        ...
        $res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297"];
        ...
        $res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with rowsize");

        $obj->setSelected(0);

        $res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0];
        $this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0];
        ...
        $res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1];
        ...
        $res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1];
        ...
        $res39 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => []];
        ...
        $res40 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0];
        ...
        $res41 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

        $obj->setTurboThreshold(27);

        $res42 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res43 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall"];
        $this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res44 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall", "visible" => 1];
        $this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setXAxis(31);

        $res45 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall", "visible" => 1, "xAxis" => 31];
        ...
        $res47 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall", "visible" => 1, "xAxis" => 31, "yAxis" => 99, "zIndex" => 14];
        $this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res48 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall", "visible" => 1, "xAxis" => 31, "yAxis" => 99, "zIndex" => 14, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res48, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res49 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 94, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 38, "borderWidth" => 60, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 87, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 90, "crisp" => 0, "cropThreshold" => 56, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 18, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 34, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 1, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 10, "selected" => 0, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 27, "type" => "waterfall", "visible" => 1, "xAxis" => 31, "yAxis" => 99, "zIndex" => 14, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
