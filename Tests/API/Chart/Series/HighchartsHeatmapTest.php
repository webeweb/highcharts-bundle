...
final class HighchartsHeatmapTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsHeatmap(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsHeatmap(false);
	...
	public function testClear() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsHeatmap(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsHeatmap(true);
	...
	public function testNewDataLabels() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsDataLabels::class, $res, "The method newDataLabels() does not return the expected object");
	}
	...
	public function testNewEvents() {
		...
		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsEvents::class, $res, "The method newEvents() does not return the expected object");
	}
	...
	public function testNewPoint() {
		...
		$res = $obj->newPoint();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsPoint::class, $res, "The method newPoint() does not return the expected object");
	}
	...
	public function testNewStates() {
		...
		$res = $obj->newStates();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
	}
	...
	public function testToArray() {
		...
		$res3 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60];
		$this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

		$res4 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
		...
		$res5 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27];
		...
		$res6 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res7 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

		$res8 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

		$obj->setColorByPoint(0);

		$res9 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
		...
		$res10 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res11 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setColsize(45);

		$res12 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with colsize");

		$obj->setCrisp(1);

		$res13 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1];
		...
		$res14 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48];
		$this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

		$obj->setCursor("crosshair");

		$res15 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair"];
		$this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res16 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		$this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data");

		$obj->setDataLabels(new \WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsDataLabels());

		$res17 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res18 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786"];
		...
		$res19 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with enable mouse tracking");

		$obj->setEvents(new \WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsEvents());

		$res20 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => []];
		$this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(1);

		$res21 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1];
		...
		$res23 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
		...
		$res24 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f"];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with id");

		$obj->setIndex(100);

		$res25 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with index");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res26 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(31);

		$res27 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res28 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setMaxPointWidth(3);

		$res29 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res30 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->setPoint(new \WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsPoint());

		$res31 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
		$this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res32 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res33 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46];
		$this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with rowsize");

		$obj->setSelected(1);

		$res34 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1];
		$this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setShadow(0);

		$res35 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0];
		...
		$res36 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0];
		...
		$res37 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1];
		$this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

		$obj->setSkipKeyboardNavigation(1);

		$res38 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1];
		$this->assertEquals($res38, $obj->toArray(), "The method toArray() does not return the expected array with skip keyboard navigation");

		$obj->setStates(new \WBW\HighchartsBundle\API\Chart\Series\Heatmap\HighchartsStates());

		$res39 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => []];
		...
		$res40 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0];
		...
		$res41 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
		$this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setTurboThreshold(74);

		$res42 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74];
		$this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

		$obj->setType("waterfall");

		$res43 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74, "type" => "waterfall"];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with type");

		$obj->setVisible(1);

		$res44 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74, "type" => "waterfall", "visible" => 1];
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with visible");

		$obj->setXAxis(32);

		$res45 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74, "type" => "waterfall", "visible" => 1, "xAxis" => 32];
		...
		$res47 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74, "type" => "waterfall", "visible" => 1, "xAxis" => 32, "yAxis" => 40, "zIndex" => 21];
		$this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res48 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 60, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 27, "borderWidth" => 99, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 20, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "colsize" => 45, "crisp" => 1, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 100, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 31, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "rowsize" => 46, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 1, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 74, "type" => "waterfall", "visible" => 1, "xAxis" => 32, "yAxis" => 40, "zIndex" => 21, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
