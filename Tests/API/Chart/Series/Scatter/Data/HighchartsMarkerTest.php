...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34];
        $this->assertEquals($res3, $obj->toArray());

        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");

        $res4 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63"];
        $this->assertEquals($res4, $obj->toArray());

        $obj->setLineWidth(30);

        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(7);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30, "radius" => 7];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setStates(new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Scatter\Data\Marker\HighchartsStates());

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30, "radius" => 7, "states" => []];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setSymbol("triangle-down");

        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30, "radius" => 7, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray());

        $obj->setWidth(1);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 34, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 30, "radius" => 7, "states" => [], "symbol" => "triangle-down", "width" => 1];
