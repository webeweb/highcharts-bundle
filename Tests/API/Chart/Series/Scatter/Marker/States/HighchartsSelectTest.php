...
final class HighchartsSelectTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\Marker\States\HighchartsSelect(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\Marker\States\HighchartsSelect(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\Marker\States\HighchartsSelect(true);
	...
	public function testToArray() {
		...
		$res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 47, "radius" => 29];
