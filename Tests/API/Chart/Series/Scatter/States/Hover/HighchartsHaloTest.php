...
final class HighchartsHaloTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\States\Hover\HighchartsHalo(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\States\Hover\HighchartsHalo(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Scatter\States\Hover\HighchartsHalo(true);
	...
	public function testToArray() {
		...
		$res2 = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 99];
		$this->assertEquals($res2, $obj->toArray(), "The method toArray() does not return the expected array with opacity");

		$obj->setSize(67);

		$res3 = ["attributes" => ["attributes" => "736b91750e516139acc13c5eb6564f92"], "opacity" => 99, "size" => 67];
