...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewHover() {
		...
		$res = $obj->newHover();
		$this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Spline\States\HighchartsHover::class, $res, "The method newHover() does not return the expected object");
	}
