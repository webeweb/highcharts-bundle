...
final class HighchartsTreemapTest extends PHPUnit_Framework_TestCase {
	...
	public function testNewDataLabels() {
		...
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Treemap\HighchartsDataLabels::class, $res, "The method newDataLabels() does not return the expected class");
	}
	...
	public function testNewEvents() {
		...
		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Treemap\HighchartsEvents::class, $res, "The method newEvents() does not return the expected class");
	}
	...
	public function testNewPoint() {
		...
		$res = $obj->newPoint();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Treemap\HighchartsPoint::class, $res, "The method newPoint() does not return the expected class");
	}
	...
	public function testNewStates() {
		...
		$res = $obj->newStates();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Treemap\HighchartsStates::class, $res, "The method newStates() does not return the expected class");
	}
	...
	public function testNewTooltip() {
		...
		$res = $obj->newTooltip();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Treemap\HighchartsTooltip::class, $res, "The method newTooltip() does not return the expected class");
	}
	...
	public function testToArray() {
		...
		$res18 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"]];
		$this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with levels");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res19 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setMaxPointWidth(43);

		$res20 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43];
		$this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res21 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->newPoint();

		$res22 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
		$this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res23 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res24 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with skip keyboard navigation");

		$obj->setSortIndex(62);

		$res25 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with sort index");

		$obj->newStates();

		$res26 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62, "states" => []];
		$this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with states");

		$obj->newTooltip();

		$res27 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62, "states" => [], "tooltip" => []];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setType("waterfall");

		$res28 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62, "states" => [], "tooltip" => [], "type" => "waterfall"];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with type");

		$obj->setZIndex(99);

		$res29 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62, "states" => [], "tooltip" => [], "type" => "waterfall", "zIndex" => 99];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res30 = ["allowDrillToNode" => false, "allowPointSelect" => false, "alternateStartingDirection" => false, "animation" => true, "borderColor" => "#e6e6e6", "borderWidth" => 1, "colorByPoint" => false, "crisp" => true, "cropThreshold" => 300, "enableMouseTracking" => true, "getExtremesFromAll" => false, "ignoreHiddenPoint" => true, "layoutAlgorithm" => "sliceAndDice", "layoutStartingDirection" => "vertical", "levelIsConstant" => true, "opacity" => 0.15, "selected" => false, "shadow" => false, "showCheckbox" => false, "showInLegend" => false, "stickyTracking" => true, "turboThreshold" => 1000, "visible" => true, "xAxis" => "0", "yAxis" => "0", "zoneAxis" => "y", "animationLimit" => 9, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 80, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 0, "interactByLeaf" => true, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "levels" => ["levels" => "836eb5e382b5d9f430df48883fca918e"], "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 43, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "skipKeyboardNavigation" => 0, "sortIndex" => 62, "states" => [], "tooltip" => [], "type" => "waterfall", "zIndex" => 99, "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
