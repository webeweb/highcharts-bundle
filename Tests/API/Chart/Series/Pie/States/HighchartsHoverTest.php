...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res4 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 59];
		...
		$res5 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 59, "lineWidthPlus" => 96];
		...
		$res6 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 59, "lineWidthPlus" => 96, "marker" => []];
