...
final class HighchartsBarTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $obj->setAnimationLimit(98);

        $res3 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        ...
        $res5 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31];
        ...
        $res6 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(0);

        $res9 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
        ...
        $res10 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(0);

        $res12 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(26);

        $res13 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair"];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res15 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        ...
        $res16 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(100);

        $res17 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res18 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res19 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(32);

        $res20 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32];
        ...
        $res21 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0];
        ...
        $res22 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => []];
        $this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(0);

        $res23 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0];
        ...
        $res24 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
        ...
        $res25 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        ...
        $res26 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with group padding");

        $obj->setGroupZPadding(33);

        $res27 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(1);

        $res28 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setId("b80bb7740288fda1f201890375a60c8f");

        $res29 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(63);

        $res30 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res31 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(23);

        $res32 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res33 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        ...
        $res34 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20];
        ...
        $res35 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with min point length");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res36 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297"];
        $this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with name");

        $obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

        $res37 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
        ...
        $res39 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(39);

        $res40 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39];
        $this->assertEquals($res40, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res41 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year"];
        ...
        $res42 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res43 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between"];
        $this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

        $obj->setPointRange(89);

        $res44 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89];
        ...
        $res45 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72];
        $this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with point start");

        $obj->setPointWidth(28);

        $res46 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(1);

        $res47 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1];
        $this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res48 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0];
        ...
        $res49 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1];
        ...
        $res50 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1];
        ...
        $res52 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0];
        ...
        $res53 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760"];
        ...
        $res54 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent"];
        ...
        $res55 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => []];
        ...
        $res56 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1];
        $this->assertEquals($res56, $obj->toArray(), "The method toArray() does not return the expected array with sticky tracking");

        $obj->setThreshold(31);

        $res57 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31];
        $this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with threshold");

        $obj->setTooltip(["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]);

        $res58 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        $this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

        $obj->setTurboThreshold(37);

        $res59 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37];
        $this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res60 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall"];
        $this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res61 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1];
        $this->assertEquals($res61, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setXAxis(35);

        $res62 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1, "xAxis" => 35];
        $this->assertEquals($res62, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

        $obj->setYAxis(7);

        $res63 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1, "xAxis" => 35, "yAxis" => 7];
        $this->assertEquals($res63, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

        $obj->setZIndex(35);

        $res64 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1, "xAxis" => 35, "yAxis" => 7, "zIndex" => 35];
        $this->assertEquals($res64, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res65 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1, "xAxis" => 35, "yAxis" => 7, "zIndex" => 35, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res65, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res66 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 98, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 31, "borderWidth" => 14, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 71, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 26, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 100, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 33, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 63, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 23, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 20, "minPointLength" => 58, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 39, "pointIntervalUnit" => "year", "pointPadding" => 80, "pointPlacement" => "between", "pointRange" => 89, "pointStart" => 72, "pointWidth" => 28, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 1, "skipKeyboardNavigation" => 0, "softThreshold" => 0, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 1, "threshold" => 31, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 37, "type" => "waterfall", "visible" => 1, "xAxis" => 35, "yAxis" => 7, "zIndex" => 35, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
