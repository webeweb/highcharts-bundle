...
final class HighchartsBoxplotTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res3 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res4 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res5 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with color by point");

        $obj->setColorIndex(5);

        $res6 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res7 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(0);

        $res8 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCursor("crosshair");

        $res9 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair"];
        $this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res10 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with data");

        $obj->setDepth(80);

        $res11 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res12 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res13 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(77);

        $res14 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

        $obj->setEnableMouseTracking(1);

        $res15 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1];
        ...
        $res16 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(1);

        $res17 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res18 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with fill color");

        $obj->setFindNearestPointBy("xy");

        $res19 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy"];
        ...
        $res20 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        ...
        $res21 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0];
        $this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with group padding");

        $obj->setGroupZPadding(90);

        $res22 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90];
        $this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(1);

        $res23 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1];
        $this->assertEquals($res23, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setId("b80bb7740288fda1f201890375a60c8f");

        $res24 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(39);

        $res25 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39];
        $this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res26 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(69);

        $res27 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLineWidth(86);

        $res28 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res29 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMaxPointWidth(10);

        $res30 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10];
        ...
        $res31 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626"];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with median color");

        $obj->setMedianWidth(98);

        $res32 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with median width");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res33 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297"];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with name");

        $obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

        $res34 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
        ...
        $res35 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => []];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res36 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $res37 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res38 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year"];
        ...
        $res39 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res40 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between"];
        ...
        $res41 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point range");

        $obj->setPointStart(66);

        $res42 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66];
        ...
        $res43 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85];
        ...
        $res45 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0];
        ...
        $res46 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res47 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
        ...
        $res50 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot"];
        $this->assertEquals($res50, $obj->toArray(), "The method toArray() does not return the expected array with stem dash style");

        $obj->setStemWidth(29);

        $res51 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29];
        ...
        $res52 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1];
        ...
        $res53 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res54 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res55 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res56 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1];
        ...
        $res57 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38"];
        $this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with whisker color");

        $obj->setWhiskerLength(11);

        $res58 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11];
        $this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with whisker length");

        $obj->setWhiskerWidth(9);

        $res59 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9];
        $this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with whisker width");

        $obj->setXAxis(33);

        $res60 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9, "xAxis" => 33];
        $this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

        $obj->setYAxis(17);

        $res61 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9, "xAxis" => 33, "yAxis" => 17];
        $this->assertEquals($res61, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

        $obj->setZIndex(54);

        $res62 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9, "xAxis" => 33, "yAxis" => 17, "zIndex" => 54];
        $this->assertEquals($res62, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res63 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9, "xAxis" => 33, "yAxis" => 17, "zIndex" => 54, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res63, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res64 = ["allowPointSelect" => 1, "animationLimit" => 7, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 5, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 80, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 77, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 0, "groupZPadding" => 90, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 39, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 69, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 10, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 98, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 77, "pointIntervalUnit" => "year", "pointPadding" => 51, "pointPlacement" => "between", "pointRange" => 53, "pointStart" => 66, "pointWidth" => 85, "selected" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 29, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 2, "type" => "waterfall", "visible" => 1, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 11, "whiskerWidth" => 9, "xAxis" => 33, "yAxis" => 17, "zIndex" => 54, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
