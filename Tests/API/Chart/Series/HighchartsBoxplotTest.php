...
final class HighchartsBoxplotTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res2 = ["allowPointSelect" => 0, "animationLimit" => 21];
		$this->assertEquals($res2, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res3 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

		$res4 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
		$this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with color");

		$obj->setColorByPoint(1);

		$res5 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
		...
		$res6 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res7 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setCrisp(1);

		$res8 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

		$obj->setCursor("crosshair");

		$res9 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair"];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res10 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with data");

		$obj->setDepth(16);

		$res11 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with depth");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res12 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786"];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with description");

		$obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

		$res13 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

		$obj->setEdgeWidth(16);

		$res14 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16];
		...
		$res15 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0];
		...
		$res16 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => []];
		$this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(0);

		$res17 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0];
		...
		$res18 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd"];
		$this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with fill color");

		$obj->setFindNearestPointBy("xy");

		$res19 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy"];
		...
		$res20 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
		...
		$res21 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34];
		$this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with group padding");

		$obj->setGroupZPadding(34);

		$res22 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34];
		$this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

		$obj->setGrouping(0);

		$res23 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0];
		$this->assertEquals($res23, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

		$obj->setId("b80bb7740288fda1f201890375a60c8f");

		$res24 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with id");

		$obj->setIndex(41);

		$res25 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with index");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res26 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(62);

		$res27 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLineWidth(86);

		$res28 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with line width");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res29 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		...
		$res30 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14];
		...
		$res31 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626"];
		$this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with median color");

		$obj->setMedianWidth(19);

		$res32 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19];
		$this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with median width");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res33 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

		$res34 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
		...
		$res35 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => []];
		$this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res36 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res37 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87];
		$this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

		$obj->setPointIntervalUnit("year");

		$res38 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year"];
		$this->assertEquals($res38, $obj->toArray(), "The method toArray() does not return the expected array with point interval unit");

		$obj->setPointPadding(45);

		$res39 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45];
		$this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

		$obj->setPointPlacement("between");

		$res40 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between"];
		$this->assertEquals($res40, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

		$obj->setPointRange(2);

		$res41 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2];
		...
		$res42 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18];
		...
		$res43 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with point width");

		$obj->setSelected(0);

		$res44 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0];
		...
		$res45 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1];
		...
		$res46 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0];
		$this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

		$obj->setSkipKeyboardNavigation(1);

		$res47 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
		...
		$res50 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot"];
		$this->assertEquals($res50, $obj->toArray(), "The method toArray() does not return the expected array with stem dash style");

		$obj->setStemWidth(18);

		$res51 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18];
		...
		$res52 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1];
		...
		$res53 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
		...
		$res55 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall"];
		$this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with type");

		$obj->setVisible(0);

		$res56 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0];
		...
		$res57 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38"];
		$this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with whisker color");

		$obj->setWhiskerLength(77);

		$res58 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77];
		$this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with whisker length");

		$obj->setWhiskerWidth(15);

		$res59 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15];
		$this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with whisker width");

		$obj->setXAxis(2);

		$res60 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15, "xAxis" => 2];
		$this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

		$obj->setYAxis(59);

		$res61 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15, "xAxis" => 2, "yAxis" => 59];
		$this->assertEquals($res61, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

		$obj->setZIndex(90);

		$res62 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15, "xAxis" => 2, "yAxis" => 59, "zIndex" => 90];
		$this->assertEquals($res62, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res63 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15, "xAxis" => 2, "yAxis" => 59, "zIndex" => 90, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res63, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res64 = ["allowPointSelect" => 0, "animationLimit" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 83, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "depth" => 16, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 16, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 34, "groupZPadding" => 34, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 41, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 62, "lineWidth" => 86, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 14, "medianColor" => "c7dbc658d3d58056469f6d2d5a8a3626", "medianWidth" => 19, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 87, "pointIntervalUnit" => "year", "pointPadding" => 45, "pointPlacement" => "between", "pointRange" => 2, "pointStart" => 18, "pointWidth" => 28, "selected" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stemColor" => "98696f23b6ed2a881042dfa365a28d23", "stemDashStyle" => "LongDashDotDot", "stemWidth" => 18, "stickyTracking" => 1, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 95, "type" => "waterfall", "visible" => 0, "whiskerColor" => "3176f361ab524a038497eb1a6c93df38", "whiskerLength" => 77, "whiskerWidth" => 15, "xAxis" => 2, "yAxis" => 59, "zIndex" => 90, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
