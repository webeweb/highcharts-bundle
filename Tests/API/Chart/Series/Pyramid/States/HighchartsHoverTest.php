...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["animation" => 0, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 31];
        ...
        $res5 = ["animation" => 0, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 31, "lineWidthPlus" => 51];
        ...
        $res6 = ["animation" => 0, "enabled" => 1, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 31, "lineWidthPlus" => 51, "marker" => []];
