...
final class HighchartsPointTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewEvents() {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Treemap\Point\HighchartsEvents::class, $res, "The method newEvents() does not return the expected object");
    }
