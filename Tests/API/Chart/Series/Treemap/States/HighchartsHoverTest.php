 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\Series\Treemap\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Treemap\States\HighchartsHover(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Treemap\States\HighchartsHover(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\Series\Treemap\States\HighchartsHover(true);
    ...
    public function testToArray() {
        ...
        $obj->setBrightness(34);

        $res3 = ["animation" => 1, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 34];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with brightness");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res4 = ["animation" => 1, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 34, "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setEnabled(1);

        $res5 = ["animation" => 1, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 34, "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "enabled" => 1];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with enabled");

        $obj->setOpacity(54);

        $res6 = ["animation" => 1, "borderColor" => "97da935a74593c55d78be9d1295aa994", "brightness" => 34, "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "enabled" => 1, "opacity" => 54];
