...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Area\States\Hover;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Area\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Area\States\Hover\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Area\States\Hover\HighchartsMarker(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Area\States\Hover\HighchartsMarker(true);
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 99, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(34);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 99, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 34];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates("");

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 99, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 34, "states" => ""];
        ...
        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 99, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 34, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(95);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 99, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 34, "states" => "", "symbol" => "triangle-down", "width" => 95];
