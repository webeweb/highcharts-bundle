...
use WBW\HighchartsBundle\API\Chart\Series\Area\Data\Marker\HighchartsStates;
...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res6 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 38, "states" => [], "symbol" => "triangle-down", "width" => 39];
