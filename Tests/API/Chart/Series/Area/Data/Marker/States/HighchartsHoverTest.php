...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 14];
        $this->assertEquals($res4, $obj->toArray());

        $obj->setLineWidthPlus(49);

        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 14, "lineWidthPlus" => 49];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(34);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 14, "lineWidthPlus" => 49, "radius" => 34];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setRadiusPlus(94);

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 14, "lineWidthPlus" => 49, "radius" => 34, "radiusPlus" => 94];
