...
namespace WBW\HighchartsBundle\Tests\API\Chart\Series\Column\Data;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\Series\Column\Data
 * @version 5.0.14
 */
final class HighchartsEventsTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Column\Data\HighchartsEvents(true);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Column\Data\HighchartsEvents(true);
