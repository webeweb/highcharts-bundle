...
namespace WBW\HighchartsBundle\Tests\API\Chart\Series\Errorbar\States\Hover;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\Series\Errorbar\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Errorbar\States\Hover\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Errorbar\States\Hover\HighchartsMarker(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\Series\Errorbar\States\Hover\HighchartsMarker(true);
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 16, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 10];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(85);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 16, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 10, "radius" => 85];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates("");

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 16, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 10, "radius" => 85, "states" => ""];
        ...
        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 16, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 10, "radius" => 85, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(55);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 16, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 10, "radius" => 85, "states" => "", "symbol" => "triangle-down", "width" => 55];
