...
final class HighchartsDataTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res4 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786"];
		...
		$res5 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => []];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setHigh(36);

		$res6 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with high");

		$obj->setId("b80bb7740288fda1f201890375a60c8f");

		$res7 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f"];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with id");

		$obj->setLabelrank(48);

		$res8 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 48];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with labelrank");

		$obj->setLow(14);

		$res9 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 48, "low" => 14];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with low");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res10 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 48, "low" => 14, "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->setSelected(0);

		$res11 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 48, "low" => 14, "name" => "b068931cc450442b63f5b3d276ea4297", "selected" => 0];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setX(91);

		$res12 = ["className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 45, "description" => "67daf92c833c41c95db874e18fcb2786", "events" => [], "high" => 36, "id" => "b80bb7740288fda1f201890375a60c8f", "labelrank" => 48, "low" => 14, "name" => "b068931cc450442b63f5b3d276ea4297", "selected" => 0, "x" => 91];
