...
final class HighchartsWaterfallTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res3 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5];
		$this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

		$res4 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
		...
		$res5 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59];
		...
		$res6 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res7 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820"];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

		$obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

		$res8 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

		$obj->setColorByPoint(0);

		$res9 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
		...
		$res10 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res11 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setCrisp(0);

		$res12 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

		$obj->setCursor("crosshair");

		$res13 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair"];
		...
		$res14 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e"];
		$this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with dash style");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res15 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		...
		$res16 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
		$this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDepth(62);

		$res17 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with depth");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res18 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786"];
		$this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

		$obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

		$res19 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

		$obj->setEdgeWidth(63);

		$res20 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63];
		$this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

		$obj->setEnableMouseTracking(1);

		$res21 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1];
		...
		$res22 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => []];
		$this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(0);

		$res23 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0];
		...
		$res24 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
		...
		$res25 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with get extremes from all");

		$obj->setGroupPadding(35);

		$res26 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35];
		...
		$res27 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

		$obj->setGrouping(0);

		$res28 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

		$obj->setId("b80bb7740288fda1f201890375a60c8f");

		$res29 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with id");

		$obj->setIndex(93);

		$res30 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93];
		$this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with index");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res31 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(0);

		$res32 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0];
		$this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");

		$res33 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63"];
		$this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with line color");

		$obj->setLineWidth(69);

		$res34 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69];
		$this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with line width");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res35 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setMaxPointWidth(53);

		$res36 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53];
		$this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

		$obj->setMinPointLength(6);

		$res37 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6];
		$this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with min point length");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res38 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297"];
		...
		$res39 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
		$this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res40 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$obj->setPointInterval(1);

		$res41 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1];
		$this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

		$obj->setPointIntervalUnit("year");

		$res42 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year"];
		$this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with point interval unit");

		$obj->setPointPadding(91);

		$res43 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

		$obj->setPointPlacement("between");

		$res44 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between"];
		...
		$res45 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75];
		$this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with point range");

		$obj->setPointStart(16);

		$res46 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16];
		...
		$res47 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64];
		$this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with point width");

		$obj->setSelected(1);

		$res48 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1];
		$this->assertEquals($res48, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setShadow(0);

		$res49 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0];
		...
		$res50 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0];
		...
		$res51 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0];
		$this->assertEquals($res51, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

		$obj->setSkipKeyboardNavigation(1);

		$res52 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
		...
		$res53 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1];
		...
		$res55 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => []];
		...
		$res56 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0];
		$this->assertEquals($res56, $obj->toArray(), "The method toArray() does not return the expected array with sticky tracking");

		$obj->setThreshold(3);

		$res57 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3];
		$this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with threshold");

		$obj->setTooltip(["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]);

		$res58 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
		$this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setType("waterfall");

		$res59 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall"];
		...
		$res60 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957"];
		$this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with up color");

		$obj->setVisible(0);

		$res61 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0];
		$this->assertEquals($res61, $obj->toArray(), "The method toArray() does not return the expected array with visible");

		$obj->setXAxis(17);

		$res62 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "xAxis" => 17];
		$this->assertEquals($res62, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

		$obj->setYAxis(43);

		$res63 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "xAxis" => 17, "yAxis" => 43];
		$this->assertEquals($res63, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

		$obj->setZIndex(4);

		$res64 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "xAxis" => 17, "yAxis" => 43, "zIndex" => 4];
		$this->assertEquals($res64, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res65 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "xAxis" => 17, "yAxis" => 43, "zIndex" => 4, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res65, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res66 = ["allowPointSelect" => 0, "animation" => 1, "animationLimit" => 5, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 59, "borderWidth" => 16, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 67, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cursor" => "crosshair", "dashStyle" => "5ad5e24042182b1974cdf57345defe8e", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 62, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 63, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 35, "groupZPadding" => 68, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 93, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 0, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 69, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 53, "minPointLength" => 6, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 1, "pointIntervalUnit" => "year", "pointPadding" => 91, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 16, "pointWidth" => 64, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "states" => [], "stickyTracking" => 0, "threshold" => 3, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "upColor" => "a0ad37cccbf214955f19b240232be957", "visible" => 0, "xAxis" => 17, "yAxis" => 43, "zIndex" => 4, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
