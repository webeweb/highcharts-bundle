...
final class HighchartsColumnrangeTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(1);

        $res9 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(1);

        $res12 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(15);

        $res13 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair"];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res15 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with data");

        $obj->setDataLabels(["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]);

        $res16 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(31);

        $res17 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res18 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res19 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(46);

        $res20 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46];
        ...
        $res21 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0];
        ...
        $res23 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1];
        ...
        $res24 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
        ...
        $res25 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        ...
        $res26 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72];
        $this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with group padding");

        $obj->setGroupZPadding(54);

        $res27 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(0);

        $res28 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setId("b80bb7740288fda1f201890375a60c8f");

        $res29 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(66);

        $res30 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res31 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(26);

        $res32 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res33 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        ...
        $res34 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8];
        $this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

        $obj->setMinPointLength(16);

        $res35 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with min point length");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res36 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297"];
        ...
        $res37 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res38 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(26);

        $res39 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res40 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year"];
        ...
        $res41 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res42 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between"];
        ...
        $res43 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75];
        $this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with point range");

        $obj->setPointStart(67);

        $res44 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67];
        $this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with point start");

        $obj->setPointWidth(98);

        $res45 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98];
        $this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(1);

        $res46 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res47 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0];
        ...
        $res48 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0];
        ...
        $res49 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0];
        $this->assertEquals($res49, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res50 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
        ...
        $res52 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0];
        ...
        $res53 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res54 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res55 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res56 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1];
        $this->assertEquals($res56, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setXAxis(47);

        $res57 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1, "xAxis" => 47];
        $this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

        $obj->setYAxis(74);

        $res58 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1, "xAxis" => 47, "yAxis" => 74];
        $this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

        $obj->setZIndex(27);

        $res59 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1, "xAxis" => 47, "yAxis" => 74, "zIndex" => 27];
        $this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res60 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1, "xAxis" => 47, "yAxis" => 74, "zIndex" => 27, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res61 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 1, "borderWidth" => 26, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 1, "colorIndex" => 86, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 15, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 31, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 46, "enableMouseTracking" => 0, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 72, "groupZPadding" => 54, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 66, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 26, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 8, "minPointLength" => 16, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 26, "pointIntervalUnit" => "year", "pointPadding" => 100, "pointPlacement" => "between", "pointRange" => 75, "pointStart" => 67, "pointWidth" => 98, "selected" => 1, "shadow" => 0, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 47, "type" => "waterfall", "visible" => 1, "xAxis" => 47, "yAxis" => 74, "zIndex" => 27, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
