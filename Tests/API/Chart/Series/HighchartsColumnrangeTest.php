...
final class HighchartsColumnrangeTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewEvents() {
        ...
        $res = $obj->newEvents();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\HighchartsEvents::class, $res, "The method newEvents() does not return the expected object");
    }
    ...
    public function testNewPoint() {
        ...
        $res = $obj->newPoint();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\HighchartsPoint::class, $res, "The method newPoint() does not return the expected object");
    }
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res5 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99];
        ...
        $res6 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(0);

        $res9 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
        ...
        $res10 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(0);

        $res12 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(48);

        $res13 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair"];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res15 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        $this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with data");

        $obj->setDataLabels(["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]);

        $res16 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(6);

        $res17 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res18 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res19 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(66);

        $res20 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66];
        $this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

        $obj->setEnableMouseTracking(1);

        $res21 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1];
        ...
        $res22 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(0);

        $res23 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0];
        ...
        $res24 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
        ...
        $res25 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
        $this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with get extremes from all");

        $obj->setGroupPadding(7);

        $res26 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7];
        ...
        $res27 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(0);

        $res28 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setId("b80bb7740288fda1f201890375a60c8f");

        $res29 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(58);

        $res30 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res31 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(32);

        $res32 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res33 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMaxPointWidth(61);

        $res34 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61];
        ...
        $res35 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with min point length");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res36 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297"];
        ...
        $res37 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
        $this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with point");

        $obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

        $res38 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(67);

        $res39 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67];
        $this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res40 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year"];
        ...
        $res41 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res42 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between"];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

        $obj->setPointRange(15);

        $res43 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15];
        ...
        $res44 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18];
        $this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with point start");

        $obj->setPointWidth(0);

        $res45 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0];
        $this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(1);

        $res46 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(0);

        $res47 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0];
        ...
        $res48 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1];
        ...
        $res49 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0];
        $this->assertEquals($res49, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res50 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
        ...
        $res52 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0];
        ...
        $res53 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        $this->assertEquals($res53, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

        $obj->setTurboThreshold(57);

        $res54 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57];
        $this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res55 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall"];
        $this->assertEquals($res55, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res56 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1];
        $this->assertEquals($res56, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setXAxis(27);

        $res57 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1, "xAxis" => 27];
        $this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

        $obj->setYAxis(36);

        $res58 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1, "xAxis" => 27, "yAxis" => 36];
        $this->assertEquals($res58, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

        $obj->setZIndex(4);

        $res59 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1, "xAxis" => 27, "yAxis" => 36, "zIndex" => 4];
        $this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res60 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1, "xAxis" => 27, "yAxis" => 36, "zIndex" => 4, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res61 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 87, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 99, "borderWidth" => 80, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 74, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 0, "cropThreshold" => 48, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "depth" => 6, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 66, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "groupPadding" => 7, "groupZPadding" => 71, "grouping" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 58, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 32, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 61, "minPointLength" => 66, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 67, "pointIntervalUnit" => "year", "pointPadding" => 38, "pointPlacement" => "between", "pointRange" => 15, "pointStart" => 18, "pointWidth" => 0, "selected" => 1, "shadow" => 0, "showCheckbox" => 1, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 57, "type" => "waterfall", "visible" => 1, "xAxis" => 27, "yAxis" => 36, "zIndex" => 4, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
