...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 57, "lineWidthPlus" => 72];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(32);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 57, "lineWidthPlus" => 72, "radius" => 32];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setRadiusPlus(14);

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 57, "lineWidthPlus" => 72, "radius" => 32, "radiusPlus" => 14];
