...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res6 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 39, "states" => "", "symbol" => "97bff26855a8bfa63e05d5477e794b24", "width" => 23];
