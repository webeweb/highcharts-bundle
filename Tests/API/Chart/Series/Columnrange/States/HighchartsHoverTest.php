...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Columnrange\States;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Columnrange\States
 * @version 5.0.14
 */
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\HighchartsHover(true);
        ...
        $obj0 = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\HighchartsHover(false);
    ...
    public function testClear() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\HighchartsHover(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\HighchartsHover(true);
    ...
    public function testNewMarker() {
        ...
        $res = $obj->newMarker();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\Hover\HighchartsMarker::class, $res, "The method newMarker() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res4 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 100];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setLineWidthPlus(16);

        $res5 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 100, "lineWidthPlus" => 16];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width plus");

        $obj->setMarker(new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Columnrange\States\Hover\HighchartsMarker());

        $res6 = ["animation" => 0, "enabled" => 0, "halo" => ["halo" => "57f842286171094855e51fc3a541c1e2"], "lineWidth" => 100, "lineWidthPlus" => 16, "marker" => []];
