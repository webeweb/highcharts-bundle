...
final class HighchartsColumnTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $obj->setAnimationLimit(6);

        $res3 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

        $obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

        $res4 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
        ...
        $res5 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39];
        ...
        $res6 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with border width");

        $obj->setClassName("6f66e878c62db60568a3487869695820");

        $res7 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with class name");

        $obj->setColor("70dda5dfb8053dc6d1c492574bce9bfd");

        $res8 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color");

        $obj->setColorByPoint(0);

        $res9 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0];
        ...
        $res10 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70];
        $this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with color index");

        $obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

        $res11 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
        $this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with colors");

        $obj->setCrisp(1);

        $res12 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1];
        $this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with crisp");

        $obj->setCropThreshold(73);

        $res13 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73];
        $this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

        $obj->setCursor("crosshair");

        $res14 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair"];
        $this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

        $obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

        $res15 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
        ...
        $res16 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
        $this->assertEquals($res16, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

        $obj->setDepth(39);

        $res17 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39];
        $this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with depth");

        $obj->setDescription("67daf92c833c41c95db874e18fcb2786");

        $res18 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786"];
        $this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with description");

        $obj->setEdgeColor("acbab0d2e7e54e5a7a32fc80409601fc");

        $res19 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc"];
        $this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with edge color");

        $obj->setEdgeWidth(32);

        $res20 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32];
        $this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with edge width");

        $obj->setEnableMouseTracking(1);

        $res21 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1];
        ...
        $res22 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => []];
        $this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with events");

        $obj->setExposeElementToA11y(0);

        $res23 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0];
        ...
        $res24 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy"];
        ...
        $res25 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1];
        ...
        $res26 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85];
        ...
        $res27 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51];
        $this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with group z padding");

        $obj->setGrouping(1);

        $res28 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1];
        $this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with grouping");

        $obj->setId("b80bb7740288fda1f201890375a60c8f");

        $res29 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f"];
        $this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with id");

        $obj->setIndex(45);

        $res30 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45];
        $this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with index");

        $obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

        $res31 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
        $this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with keys");

        $obj->setLegendIndex(68);

        $res32 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68];
        $this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

        $obj->setLinkedTo("914fab47afc86331ec62837807a29419");

        $res33 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419"];
        $this->assertEquals($res33, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

        $obj->setMaxPointWidth(6);

        $res34 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6];
        $this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with max point width");

        $obj->setMinPointLength(46);

        $res35 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46];
        $this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with min point length");

        $obj->setName("b068931cc450442b63f5b3d276ea4297");

        $res36 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297"];
        $this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with name");

        $obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

        $res37 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
        ...
        $res39 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
        ...
        $obj->setPointInterval(0);

        $res40 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0];
        $this->assertEquals($res40, $obj->toArray(), "The method toArray() does not return the expected array with point interval");

        $obj->setPointIntervalUnit("year");

        $res41 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year"];
        $this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with point interval unit");

        $obj->setPointPadding(49);

        $res42 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49];
        $this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with point padding");

        $obj->setPointPlacement("between");

        $res43 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between"];
        $this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with point placement");

        $obj->setPointRange(77);

        $res44 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77];
        $this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with point range");

        $obj->setPointStart(84);

        $res45 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84];
        ...
        $res46 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95];
        $this->assertEquals($res46, $obj->toArray(), "The method toArray() does not return the expected array with point width");

        $obj->setSelected(1);

        $res47 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1];
        $this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with selected");

        $obj->setShadow(1);

        $res48 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1];
        ...
        $res49 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0];
        ...
        $res50 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0];
        $this->assertEquals($res50, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

        $obj->setSkipKeyboardNavigation(1);

        $res51 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
        ...
        $res52 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1];
        ...
        $res53 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760"];
        ...
        $res55 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => []];
        ...
        $res56 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0];
        $this->assertEquals($res56, $obj->toArray(), "The method toArray() does not return the expected array with sticky tracking");

        $obj->setThreshold(98);

        $res57 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98];
        $this->assertEquals($res57, $obj->toArray(), "The method toArray() does not return the expected array with threshold");

        $obj->setTooltip(["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]);

        $res58 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
        ...
        $res59 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98];
        $this->assertEquals($res59, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

        $obj->setType("waterfall");

        $res60 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall"];
        $this->assertEquals($res60, $obj->toArray(), "The method toArray() does not return the expected array with type");

        $obj->setVisible(1);

        $res61 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1];
        $this->assertEquals($res61, $obj->toArray(), "The method toArray() does not return the expected array with visible");

        $obj->setXAxis(38);

        $res62 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1, "xAxis" => 38];
        $this->assertEquals($res62, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

        $obj->setYAxis(68);

        $res63 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1, "xAxis" => 38, "yAxis" => 68];
        $this->assertEquals($res63, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

        $obj->setZIndex(55);

        $res64 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1, "xAxis" => 38, "yAxis" => 68, "zIndex" => 55];
        $this->assertEquals($res64, $obj->toArray(), "The method toArray() does not return the expected array with z index");

        $obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

        $res65 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1, "xAxis" => 38, "yAxis" => 68, "zIndex" => 55, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
        $this->assertEquals($res65, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

        $obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

        $res66 = ["allowPointSelect" => 0, "animation" => 0, "animationLimit" => 6, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderRadius" => 39, "borderWidth" => 21, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorByPoint" => 0, "colorIndex" => 70, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "crisp" => 1, "cropThreshold" => 73, "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 39, "description" => "67daf92c833c41c95db874e18fcb2786", "edgeColor" => "acbab0d2e7e54e5a7a32fc80409601fc", "edgeWidth" => 32, "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 0, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "groupPadding" => 85, "groupZPadding" => 51, "grouping" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 45, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 68, "linkedTo" => "914fab47afc86331ec62837807a29419", "maxPointWidth" => 6, "minPointLength" => 46, "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 0, "pointIntervalUnit" => "year", "pointPadding" => 49, "pointPlacement" => "between", "pointRange" => 77, "pointStart" => 84, "pointWidth" => 95, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "softThreshold" => 1, "stack" => "fac2a47adace059aff113283a03f6760", "stacking" => "percent", "states" => [], "stickyTracking" => 0, "threshold" => 98, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "turboThreshold" => 98, "type" => "waterfall", "visible" => 1, "xAxis" => 38, "yAxis" => 68, "zIndex" => 55, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
