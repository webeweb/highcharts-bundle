...
final class HighchartsPieTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res3 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54];
		$this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

		$res4 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
		...
		$res5 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54];
		...
		$res6 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"]];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with center");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res7 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820"];
		...
		$res8 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res9 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setCursor("crosshair");

		$res10 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair"];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res11 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		...
		$res12 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDepth(82);

		$res13 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with depth");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res14 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786"];
		...
		$res15 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0];
		$this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with enable mouse tracking");

		$obj->setEndAngle(11);

		$res16 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11];
		...
		$res17 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => []];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(1);

		$res18 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1];
		...
		$res19 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy"];
		...
		$res20 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
		...
		$res21 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f"];
		...
		$res23 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97];
		...
		$res24 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672"];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with inner size");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res25 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(40);

		$res26 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40];
		$this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res27 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setMinSize(33);

		$res28 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with min size");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res29 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297"];
		...
		$res30 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => []];
		$this->assertEquals($res30, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res31 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res32 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0];
		$this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setShadow(0);

		$res33 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0];
		...
		$res34 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1];
		...
		$res35 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24"];
		$this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with size");

		$obj->setSkipKeyboardNavigation(0);

		$res36 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0];
		$this->assertEquals($res36, $obj->toArray(), "The method toArray() does not return the expected array with skip keyboard navigation");

		$obj->setSlicedOffset(47);

		$res37 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47];
		$this->assertEquals($res37, $obj->toArray(), "The method toArray() does not return the expected array with sliced offset");

		$obj->setStartAngle(54);

		$res38 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54];
		...
		$res39 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => []];
		...
		$res40 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0];
		...
		$res41 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
		$this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setType("waterfall");

		$res42 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall"];
		...
		$res44 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 1, "zIndex" => 61];
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res45 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 1, "zIndex" => 61, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res45, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res46 = ["allowPointSelect" => 1, "animation" => 0, "animationLimit" => 54, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 54, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 21, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 82, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 0, "endAngle" => 11, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "id" => "b80bb7740288fda1f201890375a60c8f", "ignoreHiddenPoint" => 1, "index" => 97, "innerSize" => "a6d1a6164e85630d2ca35170621de672", "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 40, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 33, "name" => "b068931cc450442b63f5b3d276ea4297", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "selected" => 0, "shadow" => 0, "showInLegend" => 1, "size" => "f7bd60b75b29d79b660a2859395c1a24", "skipKeyboardNavigation" => 0, "slicedOffset" => 47, "startAngle" => 54, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 1, "zIndex" => 61, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
