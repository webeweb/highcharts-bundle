...
final class HighchartsAreasplinerangeTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsAreasplinerange(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsAreasplinerange(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsAreasplinerange(true);
	...
	public function testNewEvents() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\HighchartsAreasplinerange(false);

		$res = $obj->newEvents();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Areasplinerange\HighchartsEvents::class, $res, "The method newEvents() does not return the expected object");
	}
	...
	public function testNewPoint() {
		...
		$res = $obj->newPoint();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Areasplinerange\HighchartsPoint::class, $res, "The method newPoint() does not return the expected object");
	}
	...
	public function testNewStates() {
		...
		$res = $obj->newStates();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Areasplinerange\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
	}
	...
	public function testToArray() {
		...
		$res6 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84];
		...
		$res7 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with connect nulls");

		$obj->setCropThreshold(28);

		$res8 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with crop threshold");

		$obj->setCursor("crosshair");

		$res9 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair"];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

		$obj->setDashStyle("LongDashDotDot");

		$res10 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot"];
		$this->assertEquals($res10, $obj->toArray(), "The method toArray() does not return the expected array with dash style");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res11 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with data");

		$obj->setDataLabels(["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]);

		$res12 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"]];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res13 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786"];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with description");

		$obj->setEnableMouseTracking(1);

		$res14 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1];
		$this->assertEquals($res14, $obj->toArray(), "The method toArray() does not return the expected array with enable mouse tracking");

		$obj->setEvents(new \WBW\HighchartsBundle\API\Chart\Series\Areasplinerange\HighchartsEvents());

		$res15 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => []];
		$this->assertEquals($res15, $obj->toArray(), "The method toArray() does not return the expected array with events");

		$obj->setExposeElementToA11y(1);

		$res16 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1];
		...
		$res17 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd"];
		$this->assertEquals($res17, $obj->toArray(), "The method toArray() does not return the expected array with fill color");

		$obj->setFillOpacity(100);
		...
		$res27 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square"];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with linecap");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res28 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res28, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res29 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->setNegativeColor("52fe4d3a854b01e25193b4f35fc2040e");

		$res30 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e"];
		...
		$obj->setPoint(new \WBW\HighchartsBundle\API\Chart\Series\Areasplinerange\HighchartsPoint());
		...
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with sticky tracking");
		...
		$res47 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87];
		$this->assertEquals($res47, $obj->toArray(), "The method toArray() does not return the expected array with turbo threshold");

		$obj->setType("waterfall");

		$res48 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall"];
		$this->assertEquals($res48, $obj->toArray(), "The method toArray() does not return the expected array with type");

		$obj->setVisible(0);

		$res49 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0];
		$this->assertEquals($res49, $obj->toArray(), "The method toArray() does not return the expected array with visible");

		$obj->setXAxis(80);

		$res50 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0, "xAxis" => 80];
		$this->assertEquals($res50, $obj->toArray(), "The method toArray() does not return the expected array with x axis");

		$obj->setYAxis(22);

		$res51 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0, "xAxis" => 80, "yAxis" => 22];
		$this->assertEquals($res51, $obj->toArray(), "The method toArray() does not return the expected array with y axis");

		$obj->setZIndex(32);

		$res52 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0, "xAxis" => 80, "yAxis" => 22, "zIndex" => 32];
		$this->assertEquals($res52, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res53 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0, "xAxis" => 80, "yAxis" => 22, "zIndex" => 32, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res53, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res54 = ["allowPointSelect" => 1, "animation" => 1, "animationLimit" => 73, "className" => "6f66e878c62db60568a3487869695820", "color" => "70dda5dfb8053dc6d1c492574bce9bfd", "colorIndex" => 84, "connectNulls" => 1, "cropThreshold" => 28, "cursor" => "crosshair", "dashStyle" => "LongDashDotDot", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => ["dataLabels" => "d4d108fe6659fac79420fa083ef3adf2"], "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "fillOpacity" => 100, "findNearestPointBy" => "xy", "getExtremesFromAll" => 1, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 98, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 24, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 61, "linecap" => "square", "linkedTo" => "914fab47afc86331ec62837807a29419", "name" => "b068931cc450442b63f5b3d276ea4297", "negativeColor" => "52fe4d3a854b01e25193b4f35fc2040e", "negativeFillColor" => "a966442d64e00bf8663e7c5d9708074a", "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "pointInterval" => 31, "pointIntervalUnit" => "year", "pointPlacement" => "between", "pointStart" => 94, "selected" => 1, "shadow" => 1, "showCheckbox" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 0, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "trackByArea" => 0, "turboThreshold" => 87, "type" => "waterfall", "visible" => 0, "xAxis" => 80, "yAxis" => 22, "zIndex" => 32, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
		$this->assertEquals($res54, $obj->toArray(), "The method toArray() does not return the expected array with zones");
	}
