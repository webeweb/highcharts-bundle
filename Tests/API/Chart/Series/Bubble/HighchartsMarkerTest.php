...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsMarker(false);
    ...
    public function testJsonSerialize() {
        ...
        $obj = new \WBW\HighchartsBundle\API\Chart\Series\Bubble\HighchartsMarker(true);
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Bubble\Marker\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res3 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42];
        $this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with height");

        $obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");

        $res4 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63"];
        $this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with line color");

        $obj->setLineWidth(81);

        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 81];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setStates(new \WBW\HighchartsBundle\API\Chart\Series\Bubble\Marker\HighchartsStates());

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 81, "states" => []];
        ...
        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 81, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(91);

        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 42, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 81, "states" => [], "symbol" => "triangle-down", "width" => 91];
