...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 8, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 100];
		...
		$res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 8, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 100, "states" => []];
		...
		$res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 8, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 100, "states" => [], "symbol" => "triangle-down"];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

		$obj->setWidth(52);

		$res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 8, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 100, "states" => [], "symbol" => "triangle-down", "width" => 52];
