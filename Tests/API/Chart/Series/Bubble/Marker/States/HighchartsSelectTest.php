...
final class HighchartsSelectTest extends PHPUnit_Framework_TestCase {
	...
	public function testClear() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Bubble\Marker\States\HighchartsSelect(false);
	...
	public function testToArray() {
		...
		$res2 = ["enabled" => true, "lineColor" => "#000000", "lineWidth" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "radius" => 77];
