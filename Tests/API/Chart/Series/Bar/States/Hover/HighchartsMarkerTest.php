...
use WBW\HighchartsBundle\API\Chart\Series\Bar\States\Hover\HighchartsMarker;
...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res5 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 85, "states" => "", "symbol" => "97bff26855a8bfa63e05d5477e794b24"];
		$this->assertEquals($res5, $obj->toArray(), 'The method toArray() does not return the expected array with symbol');

		$obj->setWidth(81);

		$res6 = ["lineColor" => "#ffffff", "lineWidth" => 0, "radius" => 4, "enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 85, "states" => "", "symbol" => "97bff26855a8bfa63e05d5477e794b24", "width" => 81];
