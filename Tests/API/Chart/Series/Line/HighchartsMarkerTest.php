...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Line\Marker\HighchartsStates::class, $res);
    }
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 37, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 80];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(39);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 37, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 80, "radius" => 39];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setStates(new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Line\Marker\HighchartsStates());

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 37, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 80, "radius" => 39, "states" => []];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setSymbol("triangle-down");

        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 37, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 80, "radius" => 39, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray());

        $obj->setWidth(58);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 37, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 80, "radius" => 39, "states" => [], "symbol" => "triangle-down", "width" => 58];
