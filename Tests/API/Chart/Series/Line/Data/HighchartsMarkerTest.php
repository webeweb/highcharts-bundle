...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Line\Data\HighchartsMarker(true);
		...
		$obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Line\Data\HighchartsMarker(false);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Line\Data\HighchartsMarker(true);
	...
	public function testNewStates() {
		...
		$res = $obj->newStates();
		$this->assertInstanceOf(\WBW\HighchartsBundle\API\Chart\Series\Line\Data\Marker\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
	}
	...
	public function testToArray() {
		...
		$res3 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67];
		$this->assertEquals($res3, $obj->toArray(), "The method toArray() does not return the expected array with height");

		$obj->setLineColor("c2580eebfdbdb9fc629f50cc147c3f63");

		$res4 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63"];
		$this->assertEquals($res4, $obj->toArray(), "The method toArray() does not return the expected array with line color");

		$obj->setLineWidth(32);

		$res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

		$obj->setRadius(19);

		$res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 19];
		$this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

		$obj->setStates(new \WBW\HighchartsBundle\API\Chart\Series\Line\Data\Marker\HighchartsStates());

		$res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 19, "states" => []];
		...
		$res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 19, "states" => [], "symbol" => "triangle-down"];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

		$obj->setWidth(29);

		$res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 67, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 19, "states" => [], "symbol" => "triangle-down", "width" => 29];
