...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 2, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(60);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 2, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15, "radius" => 60];
        ...
        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 2, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15, "radius" => 60, "states" => []];
        ...
        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 2, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15, "radius" => 60, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(83);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 2, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 15, "radius" => 60, "states" => [], "symbol" => "triangle-down", "width" => 83];
