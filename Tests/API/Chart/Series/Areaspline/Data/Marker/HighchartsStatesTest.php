...
final class HighchartsStatesTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewHover() {
        ...
        $res = $obj->newHover();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Areaspline\Data\Marker\States\HighchartsHover::class, $res);
    }
    ...
    public function testNewSelect() {
        ...
        $res = $obj->newSelect();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Areaspline\Data\Marker\States\HighchartsSelect::class, $res);
    }
