...
namespace WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Areaspline\Data;
 ...
 * @package WBW\Bundle\HighchartsBundle\Tests\API\Chart\Series\Areaspline\Data
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testNewStates() {
        ...
        $res = $obj->newStates();
        $this->assertInstanceOf(\WBW\Bundle\HighchartsBundle\API\Chart\Series\Areaspline\Data\Marker\HighchartsStates::class, $res, "The method newStates() does not return the expected object");
    }
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(67);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74, "radius" => 67];
        ...
        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74, "radius" => 67, "states" => []];
        ...
        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74, "radius" => 67, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(13);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 12, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 74, "radius" => 67, "states" => [], "symbol" => "triangle-down", "width" => 13];
