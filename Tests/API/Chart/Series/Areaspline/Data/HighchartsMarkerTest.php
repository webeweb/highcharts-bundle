...
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 53, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(15);

        $res6 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 53, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 15];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setStates(new \WBW\Bundle\HighchartsBundle\API\Chart\Series\Areaspline\Data\Marker\HighchartsStates());

        $res7 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 53, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 15, "states" => []];
        $this->assertEquals($res7, $obj->toArray());

        $obj->setSymbol("triangle-down");

        $res8 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 53, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 15, "states" => [], "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray());

        $obj->setWidth(44);

        $res9 = ["enabled" => 0, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 53, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 32, "radius" => 15, "states" => [], "symbol" => "triangle-down", "width" => 44];
