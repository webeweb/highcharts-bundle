...
namespace WBW\HighchartsBundle\Tests\API\Chart\Series\Areaspline\States\Hover;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\Series\Areaspline\States\Hover
 * @version 5.0.14
 */
final class HighchartsMarkerTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructor() {
        ...
        $obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Areaspline\States\Hover\HighchartsMarker(true);
        ...
        $obj0 = new \WBW\HighchartsBundle\API\Chart\Series\Areaspline\States\Hover\HighchartsMarker(false);
    ...
    public function testToArray() {
        ...
        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31];
        $this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with line width");

        $obj->setRadius(71);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 71];
        $this->assertEquals($res6, $obj->toArray(), "The method toArray() does not return the expected array with radius");

        $obj->setStates("");

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 71, "states" => ""];
        ...
        $res8 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 71, "states" => "", "symbol" => "triangle-down"];
        $this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with symbol");

        $obj->setWidth(1);

        $res9 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "height" => 23, "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 31, "radius" => 71, "states" => "", "symbol" => "triangle-down", "width" => 1];
