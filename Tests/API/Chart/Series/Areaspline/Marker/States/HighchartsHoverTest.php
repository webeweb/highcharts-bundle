...
final class HighchartsHoverTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $res4 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 48];
        $this->assertEquals($res4, $obj->toArray());

        $obj->setLineWidthPlus(11);

        $res5 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 48, "lineWidthPlus" => 11];
        $this->assertEquals($res5, $obj->toArray());

        $obj->setRadius(77);

        $res6 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 48, "lineWidthPlus" => 11, "radius" => 77];
        $this->assertEquals($res6, $obj->toArray());

        $obj->setRadiusPlus(21);

        $res7 = ["enabled" => 1, "fillColor" => "1fde055d3ff900e04ca08bc82066d7fd", "lineColor" => "c2580eebfdbdb9fc629f50cc147c3f63", "lineWidth" => 48, "lineWidthPlus" => 11, "radius" => 77, "radiusPlus" => 21];
