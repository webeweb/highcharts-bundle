...
namespace WBW\HighchartsBundle\Tests\API\Chart\Series\Solidgauge\Data;
 ...
 * @package WBW\HighchartsBundle\Tests\API\Chart\Series\Solidgauge\Data
 * @version 5.0.14
 */
final class HighchartsEventsTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$obj1 = new \WBW\HighchartsBundle\API\Chart\Series\Solidgauge\Data\HighchartsEvents(true);
	...
	public function testJsonSerialize() {
		...
		$obj = new \WBW\HighchartsBundle\API\Chart\Series\Solidgauge\Data\HighchartsEvents(true);
