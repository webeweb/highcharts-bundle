...
final class HighchartsFunnelTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res2 = ["allowPointSelect" => 1, "animationLimit" => 36];
		$this->assertEquals($res2, $obj->toArray(), "The method toArray() does not return the expected array with animation limit");

		$obj->setBorderColor("97da935a74593c55d78be9d1295aa994");

		$res3 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994"];
		...
		$res4 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60];
		...
		$res5 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"]];
		$this->assertEquals($res5, $obj->toArray(), "The method toArray() does not return the expected array with center");

		$obj->setClassName("6f66e878c62db60568a3487869695820");

		$res6 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820"];
		...
		$res7 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30];
		$this->assertEquals($res7, $obj->toArray(), "The method toArray() does not return the expected array with color index");

		$obj->setColors(["colors" => "62848e3ce5804aa985513a7922ff87b2"]);

		$res8 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"]];
		$this->assertEquals($res8, $obj->toArray(), "The method toArray() does not return the expected array with colors");

		$obj->setCursor("crosshair");

		$res9 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair"];
		$this->assertEquals($res9, $obj->toArray(), "The method toArray() does not return the expected array with cursor");

		$obj->setData(["data" => "8d777f385d3dfec8815d20f7496026dc"]);

		$res10 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"]];
		...
		$res11 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => []];
		$this->assertEquals($res11, $obj->toArray(), "The method toArray() does not return the expected array with data labels");

		$obj->setDepth(5);

		$res12 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5];
		$this->assertEquals($res12, $obj->toArray(), "The method toArray() does not return the expected array with depth");

		$obj->setDescription("67daf92c833c41c95db874e18fcb2786");

		$res13 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786"];
		$this->assertEquals($res13, $obj->toArray(), "The method toArray() does not return the expected array with description");

		$obj->setEnableMouseTracking(1);

		$res14 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1];
		...
		$res15 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => []];
		...
		$res18 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0];
		$this->assertEquals($res18, $obj->toArray(), "The method toArray() does not return the expected array with get extremes from all");

		$obj->setHeight(77);

		$res19 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77];
		$this->assertEquals($res19, $obj->toArray(), "The method toArray() does not return the expected array with height");

		$obj->setId("b80bb7740288fda1f201890375a60c8f");

		$res20 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f"];
		$this->assertEquals($res20, $obj->toArray(), "The method toArray() does not return the expected array with id");

		$obj->setIndex(99);

		$res21 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99];
		$this->assertEquals($res21, $obj->toArray(), "The method toArray() does not return the expected array with index");

		$obj->setKeys(["keys" => "14f802e1fba977727845e8872c1743a7"]);

		$res22 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"]];
		$this->assertEquals($res22, $obj->toArray(), "The method toArray() does not return the expected array with keys");

		$obj->setLegendIndex(22);

		$res23 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22];
		$this->assertEquals($res23, $obj->toArray(), "The method toArray() does not return the expected array with legend index");

		$obj->setLinkedTo("914fab47afc86331ec62837807a29419");

		$res24 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419"];
		$this->assertEquals($res24, $obj->toArray(), "The method toArray() does not return the expected array with linked to");

		$obj->setMinSize(3);

		$res25 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3];
		$this->assertEquals($res25, $obj->toArray(), "The method toArray() does not return the expected array with min size");

		$obj->setName("b068931cc450442b63f5b3d276ea4297");

		$res26 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297"];
		$this->assertEquals($res26, $obj->toArray(), "The method toArray() does not return the expected array with name");

		$obj->setNeckHeight(83);

		$res27 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83];
		$this->assertEquals($res27, $obj->toArray(), "The method toArray() does not return the expected array with neck height");

		$obj->setNeckWidth(61);

		$res28 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61];
		...
		$res29 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => []];
		$this->assertEquals($res29, $obj->toArray(), "The method toArray() does not return the expected array with point");

		$obj->setPointDescriptionFormatter("b5fd0c15b3ca81f726e2c7b93907ba36");

		$res30 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36"];
		...
		$res31 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0];
		$this->assertEquals($res31, $obj->toArray(), "The method toArray() does not return the expected array with reversed");

		$obj->setSelected(1);

		$res32 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1];
		$this->assertEquals($res32, $obj->toArray(), "The method toArray() does not return the expected array with selected");

		$obj->setShadow(0);

		$res33 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0];
		...
		$res34 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0];
		$this->assertEquals($res34, $obj->toArray(), "The method toArray() does not return the expected array with show in legend");

		$obj->setSkipKeyboardNavigation(1);

		$res35 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1];
		$this->assertEquals($res35, $obj->toArray(), "The method toArray() does not return the expected array with skip keyboard navigation");

		$obj->setSlicedOffset(94);

		$res36 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94];
		...
		$res37 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => []];
		...
		$res38 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0];
		...
		$res39 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"]];
		$this->assertEquals($res39, $obj->toArray(), "The method toArray() does not return the expected array with tooltip");

		$obj->setType("waterfall");

		$res40 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall"];
		$this->assertEquals($res40, $obj->toArray(), "The method toArray() does not return the expected array with type");

		$obj->setVisible(0);

		$res41 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 0];
		$this->assertEquals($res41, $obj->toArray(), "The method toArray() does not return the expected array with visible");

		$obj->setWidth(28);

		$res42 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 0, "width" => 28];
		$this->assertEquals($res42, $obj->toArray(), "The method toArray() does not return the expected array with width");

		$obj->setZIndex(83);

		$res43 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 0, "width" => 28, "zIndex" => 83];
		$this->assertEquals($res43, $obj->toArray(), "The method toArray() does not return the expected array with z index");

		$obj->setZoneAxis("88421adabea658556aa3ab6c6181afad");

		$res44 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 0, "width" => 28, "zIndex" => 83, "zoneAxis" => "88421adabea658556aa3ab6c6181afad"];
		$this->assertEquals($res44, $obj->toArray(), "The method toArray() does not return the expected array with zone axis");

		$obj->setZones(["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]);

		$res45 = ["allowPointSelect" => 1, "animationLimit" => 36, "borderColor" => "97da935a74593c55d78be9d1295aa994", "borderWidth" => 60, "center" => ["center" => "adb115059e28d960fa8badfac5516667"], "className" => "6f66e878c62db60568a3487869695820", "colorIndex" => 30, "colors" => ["colors" => "62848e3ce5804aa985513a7922ff87b2"], "cursor" => "crosshair", "data" => ["data" => "8d777f385d3dfec8815d20f7496026dc"], "dataLabels" => [], "depth" => 5, "description" => "67daf92c833c41c95db874e18fcb2786", "enableMouseTracking" => 1, "events" => [], "exposeElementToA11y" => 1, "findNearestPointBy" => "xy", "getExtremesFromAll" => 0, "height" => 77, "id" => "b80bb7740288fda1f201890375a60c8f", "index" => 99, "keys" => ["keys" => "14f802e1fba977727845e8872c1743a7"], "legendIndex" => 22, "linkedTo" => "914fab47afc86331ec62837807a29419", "minSize" => 3, "name" => "b068931cc450442b63f5b3d276ea4297", "neckHeight" => 83, "neckWidth" => 61, "point" => [], "pointDescriptionFormatter" => "b5fd0c15b3ca81f726e2c7b93907ba36", "reversed" => 0, "selected" => 1, "shadow" => 0, "showInLegend" => 0, "skipKeyboardNavigation" => 1, "slicedOffset" => 94, "states" => [], "stickyTracking" => 0, "tooltip" => ["tooltip" => "ddbfc1b6aa0ad4d79c5dac7aa3b44888"], "type" => "waterfall", "visible" => 0, "width" => 28, "zIndex" => 83, "zoneAxis" => "88421adabea658556aa3ab6c6181afad", "zones" => ["zones" => "26f94136f5db8afd4e9df1e512f7fdc5"]];
