...
final class HighchartsAccessibilityTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToArray() {
        ...
        $obj->setPointDescriptionThreshold(15);
