...
final class HighchartsTooltipTest extends PHPUnit_Framework_TestCase {
	...
	public function testToArray() {
		...
		$res2 = ["animation" => true, "backgroundColor" => "rgba(247,247,247,0.85)", "borderRadius" => 3, "borderWidth" => 1, "enabled" => true, "followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "shadow" => true, "shape" => "callout", "shared" => false, "split" => false, "style" => ["color" => "#333333", "cursor" => "default", "fontSize" => "12px", "pointerEvents" => "none", "whiteSpace" => "nowrap"], "useHTML" => false, "borderColor" => "97da935a74593c55d78be9d1295aa994", "dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8"];
		...
		$res3 = ["animation" => true, "backgroundColor" => "rgba(247,247,247,0.85)", "borderRadius" => 3, "borderWidth" => 1, "enabled" => true, "followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "shadow" => true, "shape" => "callout", "shared" => false, "split" => false, "style" => ["color" => "#333333", "cursor" => "default", "fontSize" => "12px", "pointerEvents" => "none", "whiteSpace" => "nowrap"], "useHTML" => false, "borderColor" => "97da935a74593c55d78be9d1295aa994", "dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8", "formatter" => "f2ffc59487832cbad265a8fef2133592"];
		...
		$res4 = ["animation" => true, "backgroundColor" => "rgba(247,247,247,0.85)", "borderRadius" => 3, "borderWidth" => 1, "enabled" => true, "followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "shadow" => true, "shape" => "callout", "shared" => false, "split" => false, "style" => ["color" => "#333333", "cursor" => "default", "fontSize" => "12px", "pointerEvents" => "none", "whiteSpace" => "nowrap"], "useHTML" => false, "borderColor" => "97da935a74593c55d78be9d1295aa994", "dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8", "formatter" => "f2ffc59487832cbad265a8fef2133592", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6"];
		...
		$res5 = ["animation" => true, "backgroundColor" => "rgba(247,247,247,0.85)", "borderRadius" => 3, "borderWidth" => 1, "enabled" => true, "followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "shadow" => true, "shape" => "callout", "shared" => false, "split" => false, "style" => ["color" => "#333333", "cursor" => "default", "fontSize" => "12px", "pointerEvents" => "none", "whiteSpace" => "nowrap"], "useHTML" => false, "borderColor" => "97da935a74593c55d78be9d1295aa994", "dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8", "formatter" => "f2ffc59487832cbad265a8fef2133592", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044"];
		...
		$res6 = ["animation" => true, "backgroundColor" => "rgba(247,247,247,0.85)", "borderRadius" => 3, "borderWidth" => 1, "enabled" => true, "followPointer" => false, "followTouchMove" => true, "footerFormat" => "false", "hideDelay" => 500, "padding" => 8, "pointFormat" => "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>", "shadow" => true, "shape" => "callout", "shared" => false, "split" => false, "style" => ["color" => "#333333", "cursor" => "default", "fontSize" => "12px", "pointerEvents" => "none", "whiteSpace" => "nowrap"], "useHTML" => false, "borderColor" => "97da935a74593c55d78be9d1295aa994", "dateTimeLabelFormats" => "e9db9b38c23127a66165e1d8cefd5ad8", "formatter" => "f2ffc59487832cbad265a8fef2133592", "headerFormat" => "937148825f6c7c8ed3376d1834b17ac6", "pointFormatter" => "d0b51d7b9a5189f718d161b366d33044", "positioner" => "97c873b8ea05a822237283662ba3c751"];
