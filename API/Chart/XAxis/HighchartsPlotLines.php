...
final class HighchartsPlotLines implements JsonSerializable {
     ...
     * Label.
     *
     * @var \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\PlotLines\HighchartsLabel
     */
    private $label;
     ...
     * Get the label.
     *
     * @return \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\PlotLines\HighchartsLabel Returns the label.
     */
    ...
    public function newLabel() {
        $this->label = new \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\PlotLines\HighchartsLabel();
        return $this->label;
    }
     ...
     * @return \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\HighchartsPlotLines Returns the highcharts plot lines.
     */
     ...
     * Set the label.
     *
     * @param \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\PlotLines\HighchartsLabel $label The label.
     * @return \WBW\Bundle\HighchartsBundle\API\Chart\XAxis\HighchartsPlotLines Returns the highcharts plot lines.
     */
    public function setLabel(\WBW\Bundle\HighchartsBundle\API\Chart\XAxis\PlotLines\HighchartsLabel $label = null) {
        $this->label = $label;
        return $this;
    }
