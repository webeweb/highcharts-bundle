...
namespace WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States;
 ...
 * @package WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States
 * @version 5.0.14
 * @final
 */
final class HighchartsHover implements JsonSerializable {
	 ...
	 * Marker.
	 *
	 * @var \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\Hover\HighchartsMarker
	 * @deprecated
	 */
	private $marker;
	 ...
	 * Get the marker.
	 *
	 * @return \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\Hover\HighchartsMarker Returns the marker.
	 * @deprecated
	 */
	...
	public function newMarker() {
		$this->marker = new \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\Hover\HighchartsMarker();
		return $this->marker;
	}
	 ...
	 * @return \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\HighchartsHover Returns the highcharts hover.
	 */
	 ...
	 * Set the marker.
	 *
	 * @param \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\Hover\HighchartsMarker $marker The marker.
	 * @return \WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\HighchartsHover Returns the highcharts hover.
	 * @deprecated
	 */
	public function setMarker(\WBW\HighchartsBundle\API\Chart\PlotOptions\Pie\States\Hover\HighchartsMarker $marker = null) {
		$this->marker = $marker;
		return $this;
	}
