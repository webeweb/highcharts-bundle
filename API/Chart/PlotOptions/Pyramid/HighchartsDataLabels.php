...
final class HighchartsDataLabels implements JsonSerializable {
     ...
     * @return \WBW\Bundle\HighchartsBundle\API\Chart\PlotOptions\Pyramid\HighchartsDataLabels Returns the highcharts data labels.
     */
    ...
    public function toArray() {
        ...
        // Set the connector color.
        ArrayUtility::set($output, "connectorColor", $this->connectorColor, [null]);

        // Set the connector padding.
        ArrayUtility::set($output, "connectorPadding", $this->connectorPadding, [null]);

        // Set the connector width.
        ArrayUtility::set($output, "connectorWidth", $this->connectorWidth, [null]);
        ...
        // Set the soft connector.
        ArrayUtility::set($output, "softConnector", $this->softConnector, [null]);
