...
namespace WBW\HighchartsBundle\API\Chart\YAxis\PlotLines;
 ...
 * @package WBW\HighchartsBundle\API\Chart\YAxis\PlotLines
 * @version 5.0.14
 * @final
 */
final class HighchartsLabel implements JsonSerializable {
     ...
     * @return \WBW\HighchartsBundle\API\Chart\YAxis\PlotLines\HighchartsLabel Returns the highcharts label.
     */
