...
final class HighchartsPlotLines implements JsonSerializable {
     ...
     * Label.
     *
     * @var \WBW\HighchartsBundle\API\Chart\ZAxis\PlotLines\HighchartsLabel
     */
    private $label;
     ...
     * Get the label.
     *
     * @return \WBW\HighchartsBundle\API\Chart\ZAxis\PlotLines\HighchartsLabel Returns the label.
     */
    ...
    public function newLabel() {
        $this->label = new \WBW\HighchartsBundle\API\Chart\ZAxis\PlotLines\HighchartsLabel();
        return $this->label;
    }
     ...
     * @return \WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsPlotLines Returns the highcharts plot lines.
     */
     ...
     * Set the label.
     *
     * @param \WBW\HighchartsBundle\API\Chart\ZAxis\PlotLines\HighchartsLabel $label The label.
     * @return \WBW\HighchartsBundle\API\Chart\ZAxis\HighchartsPlotLines Returns the highcharts plot lines.
     */
    public function setLabel(\WBW\HighchartsBundle\API\Chart\ZAxis\PlotLines\HighchartsLabel $label = null) {
        $this->label = $label;
        return $this;
    }
