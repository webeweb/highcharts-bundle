...
namespace WBW\HighchartsBundle\API\Chart\ZAxis\PlotBands;
 ...
 * @package WBW\HighchartsBundle\API\Chart\ZAxis\PlotBands
 * @version 5.0.14
 * @final
 */
final class HighchartsLabel implements JsonSerializable {
	 ...
	 * @return \WBW\HighchartsBundle\API\Chart\ZAxis\PlotBands\HighchartsLabel Returns the highcharts label.
	 */
